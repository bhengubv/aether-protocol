...
**عمود BitTorrent:** ✅ = عميل كامل وعامل + بوابة شبكة (مرجع C#). ◐ = **صيغ الأسلاك** لـBitTorrent متطابقة بايتاً ببايت هنا (مثبتةً في `fixtures/bittorrent/`)، مع طبقة الشبكة الحية كخطوة تالية — انظر [BitTorrent — حقيقي، وموصول بجسر إلى الشبكة](#bittorrent--real-and-bridged-into-the-mesh). كل عمود آخر حقيقي وعامل في اللغات الثماني جميعاً.

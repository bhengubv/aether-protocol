...
> **بروتوكول واحد، ثماني لغات، متطابق على الأسلاك.** Aether مُطبَّق بـ**C# وRust وTypeScript وPython وGo وKotlin وSwift وC** — وكل حزمة متطابقة بالبايت عبرها جميعاً، مفروضٌ ذلك بمستودع مشترك للاختبارات متعددة اللغات يجب على كل تطبيق أن يطابقه بايتاً ببايت. ابنِ عقدتك بأيٍّ من الثماني؛ فإنها تتشغّل بينياً مع جميع الأخريات. هذا الملف التعريفي متوفر أيضاً بـ20 لغة بشرية (الروابط أعلاه).

## بعبارات بسيطة

**يتيح AetherNet للهواتف والحواسيب المحمولة أن تتحدث مع بعضها مباشرة — دون إنترنت، ودون شركة اتصالات، ودون حساب.** إذا كان لدى الأشخاص من حولك التطبيق، فيمكنك مراسلتهم، وإرسال الصور والملفات الكبيرة، وإجراء مكالمات صوتية ومرئية، ومشاركة بث مباشر، مستخدماً فقط الراديوات قصيرة المدى الموجودة أصلاً داخل كل هاتف (البلوتوث وWi-Fi). وإذا كان أحدهم أبعد من أن تصله مباشرة، تقفز رسالتك بهدوء من هاتف إلى التالي حتى تصل — وتنتظر ما يصل إلى ثلاثة أيام للعثور على مسار إن اضطرت. بل يمكنها أن تمتد إلى شبكات مشاركة الملفات العامة الكبرى في العالم (نفس التقنية وراء التنزيلات القانونية مثل Linux وتحديثات الألعاب)، فتسحب ملفاً، وتحمله إلى الداخل نحو صديق لا يملك إنترنت على الإطلاق.

كل شيء مُشفَّر من طرف إلى طرف، فلا يستطيع قراءته إلا الشخص الذي تتحدث معه — أما الهواتف التي تمرره فلا تستطيع. وهو **مجاني ومفتوح** لأي أحد كي يستخدمه أو يفحصه، ومكتوب ثماني مرات، بثماني لغات برمجة، كي يعمل على أي جهاز تقريباً.

**ما مدى اكتماله؟** إن "عقل" الشبكة — صيغ الرسائل، والتشفير، والتوجيه، ومشاركة الملفات — مبنيٌّ ومُتحقَّق منه آلياً عبر اللغات الثماني جميعاً. وما لا يزال يحتاج إلى اختبار في العالم الحقيقي هو تحدُّث الراديوات الفعلية بعضها إلى بعض عبر الأثير بين هاتفين ماديين؛ تلك الخطوة العتادية هي ما تبقّى، ونتتبعها علناً في `OPEN_ISSUES.md`. وكل ما يلي هو القصة نفسها بمزيد من التفصيل.
...
**احصل على ملف كبير بالطريقة التي يتشاركها بها الإنترنت كله أصلاً.**

BitTorrent هي التقنية وراء شريحة ضخمة من مشاركة الملفات القانونية في العالم — إصدارات Linux، وتحديثات الألعاب، وأرشيف الإنترنت. وAether الآن يتحدثها *حقاً*: يمكن لعقدة Aether أن تنضم إلى سرب BitTorrent عادي وتسحب ملفاً مباشرة من الحشد، دون خادم مركزي. وهنا المفاجأة لمن لا يملكون بيانات — عقدة Aether واحدة *تملك* إنترنت يمكنها جلب ملف تورنت و**إعادة مشاركته عبر الشبكة غير المتصلة**، فيتلقى صديق غير متصل تماماً الملفَّ مع ذلك، قفزةً بقفزة، عبر البلوتوث وWi-Fi. أكبر شبكة لمشاركة الملفات في العالم، تصل إلى الأشخاص الذين لا يصلهم الإنترنت.
...
## BitTorrent — حقيقي، وموصول بجسر إلى الشبكة

يتضمن Aether الآن **تطبيقاً أصيلاً وقابلاً للتشغيل البيني لـBitTorrent** — البروتوكول الفعلي الذي يستخدمه عملاء التورنت الحقيقيون، لا نسخةً شبيهةً به. لذا يمكن لعقدة Aether أن تنضم إلى سرب عادي وتتبادل قطع ملف مع غرباء على الإنترنت، دون خادم في الوسط.

لم نكتفِ بالادعاء بأنه حقيقي — بل أثبتناه. جرى فحص Aether مقابل **MonoTorrent**، وهي مكتبة BitTorrent ناضجة ومستقلة بناها أشخاص آخرون: فبإعطائهما الملف نفسه، يُنتج كلاهما البصمةَ *المتطابقة* ذاتها، فيعامل أي عميل تورنت حقيقي Aether كواحد من صنفه. يمكن لأي أحد أن يوجّه عميل BitTorrent حقيقياً نحوه ويرى بنفسه.

فوق ذلك، يضيف Aether **جسراً**: يمكن لعقدة تملك إنترنت أن تسحب ملف تورنت من الويب الأوسع، وتعيد تغليف قطعه كشظايا شبكة مشفَّرة خاصة بـAether، وتشاركه إلى الأمام — فيتلقى شخص **لا يملك إنترنت على الإطلاق** ذلك الملف عبر الشبكة غير المتصلة رغم ذلك. تلك هي الفكرة: وصْل أكبر شبكة لمشاركة الملفات في العالم بالأشخاص الذين لا تستطيع الوصول إليهم عادةً.

**أين يقف الأمر، بصدق.** إن *صيغ* BitTorrent — كيف يُوصَف ملف التورنت، وكيف يُبصَم، ويُؤطَّر على الأسلاك — مبنيّة و**متطابقة بايتاً ببايت في اللغات الثماني جميعاً**، مثبتةً في مستودع اختبارات مشترك في `fixtures/bittorrent/`. أما العميل العامل الكامل وجسر الشبكة فمكتملان ومتحقَّق منهما في **مرجع C#**؛ وتحمل اللغات السبع الأخرى صيغَ البروتوكول المتطابقة ذاتها، مع طبقة شبكتها الحية كخطوة تالية.

> **للمطوّرين.** التغطية: bencode + `.torrent`/magnet + info-hash بـSHA-1 وpeer-wire بـBEP-3 (الأندر أولاً)، ومتعقِّبات HTTP + UDP (BEP-3/15/23)، وMainline DHT + PEX + ut_metadata (BEP-5/11/9/10)، وµTP (BEP-29)، وmerkle بـSHA-256 لـBitTorrent v2 (BEP-52)، بالإضافة إلى **بوابة** piece↔chunk إلى خدمة المحتوى، ومُنزِّل مقطّع متزامن وقابل للاستئناف. يشحن مرجع C# (`src/AetherNet.BitTorrent`، `src/AetherNet.BitTorrent.Gateway`) عميل TCP/µTP الحي، وعقدة DHT، والمتعقِّبات، والبوابة، والمُنزِّل، مع اختبار التشغيل البيني مع MonoTorrent في `tests/AetherNet.BitTorrent.Interop.Tests`. يغطي مستودع التطابق البايتي عبر اللغات الثماني (`fixtures/bittorrent/vectors.json`، 7 فئات) الـbencode، وinfo-hash، وpeer-wire، وµTP، وmerkle، وcompact-info، وKRPC؛ ويشحن كل SDK اختبار مستودع مطابقاً.
...
| اللغة | الدليل | تنسيق الأسلاك | التوجيه/DTN/SOS | X3DH | Double Ratchet | مجموعة OPK | الصوت/المجموعة | البث/الفيديو/المشاهدة | BitTorrent |
|----------|-----------|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| C# (.NET 10) | `src/` | ✅ | ✅ | ✅ | ✅ | ✅ (100) | ✅ | ✅ | ✅ |
| Rust | `rust/` | ✅ | ✅ | ✅ | ✅ | ✅ (100) | ✅ | ✅ | ◐ |
...
**عمود BitTorrent:** ✅ = عميل كامل وعامل + بوابة شبكة (مرجع C#). ◐ = **صيغ الأسلاك** لـBitTorrent متطابقة بايتاً ببايت هنا (مثبتةً في `fixtures/bittorrent/`)، مع طبقة الشبكة الحية كخطوة تالية — انظر [BitTorrent — حقيقي، وموصول بجسر إلى الشبكة](#bittorrent-bridge). كل عمود آخر حقيقي وعامل في اللغات الثماني جميعاً.

تُنتج جميع اللغات الثماني حزمًا متطابقة بالبايت على مستوى الأسلاك، مُتحقق منها بـ17 مخرج قانونياً لتنسيق الأسلاك و6 متجهات اختبار Signal (`fixtures/expected/*.bin`، `fixtures/signal/expected/*.json`) — كل لغة تُفحَص مقابل البايتات نفسها. التوجيه (بأسلوب AODV RREQ/RREP)، وDTN للتخزين والإعادة، وبث SOS، والصوت، والبث، وخدمات تصليب الأمان مُطبَّقة في كل لغة مع **~3,000 اختبار** عبر جميع التطبيقات الثمانية:

| اللغة | الاختبارات | منصة الاختبار |
|----------|------:|-------------|
| C# (.NET 10) | 530 | Linux |
...
التشغيل البيني لـSignal متعدد اللغات مرتبط بـ`fixtures/signal/` مع متجهات اختبار مشتركة لـX3DH (`x3dh_basic`)، والتشعبات المتماثلة (`ratchet_step_basic`، `ratchet_step_three_iterations`)، وKDF_RK (`kdf_rk_basic`)، والجولة الكاملة لجلسة X3DH ذهاباً وإياباً (`x3dh_session_msg1`، `x3dh_session_reply`). يجب على كل تطبيق إنتاج مخرجات متطابقة بالبايت مقابل تلك المخرجات المحددة. تشحن جميع اللغات الثماني الآن بجلسة Signal كاملة (`generate_pre_key_bundle`، `process_pre_key_bundle`، `encrypt`، `decrypt`).

فيما يتجاوز تنسيق الأسلاك وSignal، فإن **مجموعة خدمات الأسلاك بأكملها** — الحضور، ونبضة القلب، ومزامنة الملف الشخصي، وإعلان المعرف المؤقت، وتبادل المفاتيح الأولية، والقنوات، والضغط للتحدث، ومشاركة الشاشة، والتحكم بالمكالمة، وإقرار نداء الاستغاثة، وفُتات المساحة، وإعلان المصهر، وطلب شظية الخزنة، وقياس النطاق الترددي (انظر [**ما الذي تحصل عليه — كل خدمة، بكل لغة**](#what-you-get)) — مطبَّقة كذلك في جميع اللغات الثماني ومثبتة في مستودعاتها الخاصة (`fixtures/presence/`، `fixtures/media/`، `fixtures/bandwidth/`، `fixtures/prekey/`، `fixtures/videocall/`، `fixtures/vaultshard/`، وأخواتها). لا ميزة حكرٌ على C# في طبقة البروتوكول.
...
- تنسيق الأسلاك: متطابق بالبايت عبر 8 لغات، مرتبط بـ17 مخرج قانونياً وتأكيدات متعددة اللغات (`fixtures/expected/*.bin`)
- **سير عمل GitHub Actions (معرَّف، وليس البوابة الحالية)** — مصفوفة من 9 وظائف (C#/.NET 10, Go 1.22, TypeScript/Node 20, Python 3.12, Kotlin/JVM 21, Swift/macOS, Rust stable, C/GCC, بالإضافة إلى وظيفة سلامة المخرجات) معرَّفة في `.github/workflows/ci.yml`. تُدفع الالتزامات حالياً بـ`[skip ci]`، لذا فإن الفرض الفعلي هو تشغيل مستودع الاختبارات **محلياً، لكل لغة** (Swift وC على خادم بناء macOS)؛ ويمكن إعادة تفعيل CI دون تغييرات في الكود.
...
- **~3,000 اختبار** عبر جميع اللغات الثماني (C# 530، TypeScript 459، Kotlin 457، Go 423، Python 387، Swift 295، C 253، Rust ~195) — جميعها ناجحة، تُشغَّل لكل لغة (Swift وC على خادم بناء macOS)
...
ثماني لغات — C# وRust وTypeScript وPython وGo وKotlin وSwift وC. كل تطبيق يُنتج حزمًا متطابقة بالبايت على مستوى الأسلاك، مفروضٌ ذلك بمستودع مشترك للاختبارات متعددة اللغات يُفحَص مقابله كل تطبيق، لذا فإن الحزمة التي تبنيها لغة واحدة تفكها أي لغة أخرى دون تغيير.
...
هذا الملف التعريفي مُصان أيضاً باللغات الأخرى المدرجة في شريط اللغات أعلى هذا الملف، تحت [`docs/i18n/`](docs/i18n/) — ممتداً عبر لغات أوروبية، وشرق آسيوية، وشرق أوسطية، وجنوب آسيوية، وجنوب شرق آسيوية، وأفريقية، لأن شبكةً بُنيت لأجل من لا يملكون بيانات لا ينبغي أن يكون لها بابٌ أماميّ لا يقرؤه إلا حسنو الاتصال. **النسخة الإنجليزية هي مصدر الحقيقة**: حين تختلف ترجمة عن النص الإنجليزي، يكون النص الإنجليزي هو المرجع، وقد تتأخر الترجمات عنه بإصدار أو اثنين. البروتوكول والكود والمستودعات والسلوك الموصوف متطابقة مهما كانت اللغة التي تقرأ بها.

...
Bayan tarin hidimomin waya, Aether tana ɗauke da ƙaramin **matakin tsaro & sirri** — sarrafa maɓallan shaida da kariya daga bibiya a matakin link-layer. Kamar kowane abu, an aiwatar da kowanne a cikin **dukkan harsuna 8** kuma an ɗaure shi ga fixture da ake rabawa tsakanin harsuna a ƙarƙashin `fixtures/<feature>/` (an ƙara tabbatar da Swift da C a kan macOS build server). Waɗannan *ba* wasu huɗu ne na hidimomin waya 18 ba: uku *ba sa* ayyana **wani sabon nau'in fakitin waya** ko kaɗan, kuma na huɗu yana ɗaukar nasa ambulan **cikin hanyar DTN/mesh da take nan** maimakon sabon fakiti da aka keɓe.

| Iyawa | Abin da take yi | Matakin | Fixture | 8/8 |
|---|---|---|---|:-:|
| **Ajiyar recovery-phrase** | Ajiye shaida a matsayin jimlar **kalmomi 24 na BIP-39** kuma dawo da ita a kan kowace na'ura. BIP-39 na yau da kullum (an tabbatar da shi da vectors na hukuma na Trezor), mai SHA-256 checksum ta yadda kalmar da aka rubuta ba daidai ba *a ƙi ta*, ba tare da kuskure a shiru ba. Babu server, babu mai riƙo — jimlar **ita ce** shaida. | na cikin gida | `fixtures/bip39/` | ✅ |
| **Kariya daga bibiyar Bluetooth** | Tana samar da BLE **Service UUID** mai juyawa, wanda aka samo daga maɓalli (HMAC-SHA256, taga na minti 15) da **adireshin masu zaman kansu masu warwaruwa** (IRK + aikin RFC `ah`, AES-128) — kayan hana bibiya da BLE advertiser ke buƙata domin scanner mai wucewa ba zai iya haɗa shi a fadin lokaci ko wuri ba. | link-layer | `fixtures/bleprivacy/` | ✅ |
| **Panic-wipe** | Wata **duress PIN** (SHA-256, ana kwatanta ta a lokaci mai daidaita) wadda, ƙarƙashin tilastawa, take share kowace maɓallar shaida cikin aminci — rubuta-a-kai-da-random sannan sifili — babu abin da ya rage don dawowa. | na cikin gida | `fixtures/panicwipe/` | ✅ |
| **Daidaita na'urori masu yawa** | Daidaitawa **mara tsakiya, mara server** a fadin na'urorinka *na kanka*: **DeviceLink** da aka sa hannu da Ed25519 tana haɗa su, kuma ambulan **SyncRecord** na last-write-wins suna daidaita yanayi — ana ɗauke da su a ɓoye da E2E a kan DTN/mesh da take nan, ba tare da asusun girgije da server na daidaitawa ba. | tana hawa DTN | `fixtures/sync/` | ✅ |

**Rashin daidaito ɗaya mai gaskiya.** **DeviceLink** na na'urori masu yawa an sa hannu da Ed25519, kuma wannan sa hannun yana **daidai da baiti a fadin harsuna 7 daga cikin 8**. CryptoKit na Apple da gangan *yana random* ɗin sa hannun Ed25519, don haka a kan Swift baiti 64 na sa hannun sun bambanta a kowane lokaci — amma **jikin da aka sa hannu daidai yake da baiti** kuma kowace haɗi tana ci gaba da tabbatarwa a kan dukkan SDK 8, don haka Swift tana kai wa daidaiton **tabbatarwa** maimakon daidaiton baiti na sa hannu. Wannan dukiya ce ta platform-crypto, ba lahani ba, kuma ita ce kawai wuri a cikin waɗannan siffofi huɗu inda "daidai da baiti" ke ɗauke da asterisk. Cikakkun tsarin waya suna cikin [`PROTOCOL_SPEC.md`](../../PROTOCOL_SPEC.md) §12; samfurin barazana yana cikin [`THREAT_MODEL.md`](../../THREAT_MODEL.md).

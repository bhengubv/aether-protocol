...
**BitTorrent कॉलम:** ✅ = पूर्ण, कार्यशील क्लाइंट + मेश गेटवे (C# संदर्भ)। ◐ = यहाँ BitTorrent **वायर फ़ॉर्मेट** बाइट-दर-बाइट एक जैसे हैं (`fixtures/bittorrent/` से पिन किए गए), जिनकी लाइव नेटवर्क परत अगला कदम है — देखें [BitTorrent — असली, और मेश में सेतुबद्ध](#bittorrent--real-and-bridged-into-the-mesh)। हर दूसरा कॉलम सभी 8 भाषाओं में असली और कार्यशील है।

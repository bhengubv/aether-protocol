...
تمام 8 زبانیں بائٹ-یکساں وائر پیکٹس تیار کرتی ہیں، جن کی تصدیق CI میں چلنے والے 17 کینونیکل وائر-فارمیٹ فکسچرز اور 6 Signal ٹیسٹ ویکٹرز سے ہوتی ہے (`fixtures/expected/*.bin`، `fixtures/signal/expected/*.json`)۔ روٹنگ (AODV-طرز RREQ/RREP)، DTN اسٹور-اینڈ-فارورڈ، SOS نشریہ، آواز، اسٹریمنگ، اور سیکیورٹی-سختی سروسز ہر زبان میں **~3,000 ٹیسٹس** کے ساتھ تمام 8 نفاذ میں نافذ ہیں:
...
- وائر فارمیٹ: 8 زبانوں کے آر پار بائٹ-یکساں، 17 کینونیکل فکسچرز اور CI میں کراس-لینگویج تصدیقات سے منسلک (`fixtures/expected/*.bin`)
...
آٹھ — C#، Rust، TypeScript، Python، Go، Kotlin، Swift، اور C۔ ہر نفاذ بائٹ-یکساں وائر پیکٹس تیار کرتا ہے، جسے CI میں ایک مشترکہ کراس-لینگویج فکسچر کارپس کے ذریعے نافذ کیا جاتا ہے، لہٰذا ایک زبان کا بنایا ہوا پیکٹ کسی بھی دوسری زبان بغیر کسی تبدیلی کے ڈی کوڈ کر لیتی ہے۔

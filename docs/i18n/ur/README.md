# AetherNet — آف لائن-فرسٹ میش نیٹ ورکنگ پروٹوکول
...
**AetherNet ایک اوپن-سورس، MIT-لائسنس یافتہ میش نیٹ ورکنگ پروٹوکول ہے** جو آس پاس کے لوگوں کو پیغامات، فائلیں، آواز، اور ویڈیو بھیجنے کے لیے ہے — **بغیر انٹرنیٹ، بغیر سرورز، اور بغیر سائن اپ کے**۔ آلات براہِ راست بلوٹوتھ، Wi-Fi Direct، NearLink، اور LoRa پر جڑتے ہیں؛ جب وصول کنندہ رینج سے باہر ہو، تو پیغامات دوسرے آلات سے ہوتے ہوئے آگے بڑھتے ہیں اور راستے کے انتظار میں 72 گھنٹے تک رُکے رہتے ہیں۔ یہ **آٹھ پروگرامنگ زبانوں میں بائٹ در بائٹ یکساں نفاذ** شپ کرتا ہے — C#، Rust، TypeScript، Python، Go، Kotlin، Swift، اور C۔
...
[English](../../../README.md) · [Français](../fr/README.md) · [Español](../es/README.md) · [العربية](../ar/README.md) · [中文简体](../zh-CN/README.md) · [日本語](../ja/README.md) · [Deutsch](../de/README.md) · [Português (BR)](../pt-BR/README.md) · [Русский](../ru/README.md) · [فارسی](../fa/README.md) · [한국어](../ko/README.md) · [isiZulu](../zu/README.md) · [Afrikaans](../af/README.md) · [Sesotho](../st/README.md) · [Kiswahili](../sw/README.md) · [Hausa](../ha/README.md) · [አማርኛ](../am/README.md) · [हिन्दी](../hi/README.md) · [Bahasa Indonesia](../id/README.md) · [বাংলা](../bn/README.md) · [اردو](README.md)

> **ایک پروٹوکول، آٹھ زبانیں، وائر پر ایک جیسا۔** Aether کو **C#، Rust، TypeScript، Python، Go، Kotlin، Swift، اور C** میں نافذ کیا گیا ہے — اور ہر پیکٹ ان سب میں بائٹ در بائٹ ایک جیسا ہے، جسے ایک مشترکہ کراس-لینگویج فکسچر کارپس کے ذریعے نافذ کیا جاتا ہے جس سے ہر نفاذ کو بائٹ در بائٹ مطابقت رکھنی ہوتی ہے۔ اپنا نوڈ آٹھ میں سے کسی بھی زبان میں بنائیں؛ یہ باقی سب کے ساتھ باہمی طور پر کام کرے گا۔ یہ README 20 انسانی زبانوں میں بھی دستیاب ہے (لنکس اوپر)۔

## سادہ الفاظ میں

**AetherNet فونز اور لیپ ٹاپس کو ایک دوسرے سے براہِ راست بات کرنے دیتا ہے — بغیر انٹرنیٹ، بغیر کسی فون کمپنی، اور بغیر کسی اکاؤنٹ کے۔** اگر آپ کے آس پاس کے لوگوں کے پاس ایپ ہو، تو آپ انہیں پیغام بھیج سکتے ہیں، تصاویر اور بڑی فائلیں بھیج سکتے ہیں، وائس اور ویڈیو کالیں کر سکتے ہیں، اور ایک لائیو اسٹریم شیئر کر سکتے ہیں، صرف اُن مختصر-رینج ریڈیوز کو استعمال کرتے ہوئے جو پہلے ہی ہر فون کے اندر موجود ہیں (بلوٹوتھ اور Wi-Fi)۔ اگر کوئی اتنا دور ہو کہ اُس تک براہِ راست نہ پہنچا جا سکے، تو آپ کا پیغام خاموشی سے ایک فون سے اگلے فون تک چھلانگ لگاتا رہتا ہے یہاں تک کہ وہ پہنچ جائے — اور اگر ضروری ہو تو کسی راستے کے انتظار میں تین دن تک رُکا رہتا ہے۔ یہ دنیا کے بڑے عوامی فائل-شیئرنگ نیٹ ورکس تک بھی پہنچ سکتا ہے (وہی ٹیکنالوجی جو Linux اور گیم اپڈیٹس جیسے قانونی ڈاؤن لوڈز کے پیچھے ہے)، ایک فائل کھینچ سکتا ہے، اور اسے اندر کی طرف کسی ایسے دوست تک لے جا سکتا ہے جس کے پاس بالکل بھی انٹرنیٹ نہیں۔

ہر چیز اینڈ-ٹو-اینڈ خفیہ کی جاتی ہے، لہٰذا صرف وہی شخص اسے پڑھ سکتا ہے جس سے آپ بات کر رہے ہیں — اسے آگے پہنچانے والے فون نہیں پڑھ سکتے۔ یہ کسی کے بھی استعمال یا معائنہ کرنے کے لیے **مفت اور کھلا** ہے، اور اسے آٹھ بار، آٹھ پروگرامنگ زبانوں میں لکھا گیا ہے، تاکہ یہ تقریباً کسی بھی آلے پر چل سکے۔

**یہ کتنا مکمل ہے؟** نیٹ ورک کا "دماغ" — پیغام کے فارمیٹس، خفیہ کاری، روٹنگ، اور فائل-شیئرنگ — تمام آٹھ زبانوں میں بنایا اور مشین-چیک کیا جا چکا ہے۔ جس چیز کو ابھی حقیقی-دنیا کی جانچ درکار ہے وہ دو فزیکل فونز کے درمیان ہوا کے آر پار ایک دوسرے سے بات کرتے اصل ریڈیوز ہیں؛ وہی ہارڈویئر مرحلہ باقی ہے، اور ہم اسے `OPEN_ISSUES.md` میں کھلے عام سراغ کرتے ہیں۔ نیچے دی گئی ہر چیز وہی کہانی زیادہ تفصیل سے ہے۔
...
**ایک بڑی فائل اُسی طرح حاصل کریں جیسے پورا انٹرنیٹ پہلے ہی انہیں شیئر کرتا ہے۔**

BitTorrent وہ ٹیکنالوجی ہے جو دنیا کی قانونی فائل-شیئرنگ کے ایک بڑے حصے کے پیچھے ہے — Linux ریلیزز، گیم اپڈیٹس، Internet Archive۔ Aether اب اسے *واقعی* بولتا ہے: ایک Aether نوڈ ایک عام BitTorrent سوارم میں شامل ہو سکتا ہے اور بغیر کسی مرکزی سرور کے، سیدھا مجمع سے ایک فائل کھینچ سکتا ہے۔ اور ان لوگوں کے لیے یہاں ایک دلچسپ موڑ ہے جن کے پاس ڈیٹا نہیں — ایک Aether نوڈ جس کے پاس انٹرنیٹ *ہے* وہ ایک ٹورنٹ حاصل کر سکتا ہے اور **اسے آف لائن میش کے آر پار دوبارہ-شیئر کر سکتا ہے**، تاکہ ایک دوست جو مکمل طور پر آف لائن ہے پھر بھی وہ فائل، قدم بہ قدم، بلوٹوتھ اور Wi-Fi پر وصول کر لے۔ دنیا کا سب سے بڑا فائل-شیئرنگ نیٹ ورک، اُن لوگوں تک پہنچتا ہوا جن تک انٹرنیٹ نہیں پہنچتا۔
...
## BitTorrent — اصل، اور میش میں برج کے ذریعے جُڑا

Aether اب ایک **حقیقی، باہمی-عمل پذیر BitTorrent نفاذ** شامل کرتا ہے — وہی اصل پروٹوکول جو اصلی ٹورنٹ کلائنٹس استعمال کرتے ہیں، کوئی نقل نہیں۔ چنانچہ ایک Aether نوڈ ایک عام سوارم میں شامل ہو سکتا ہے اور انٹرنیٹ پر اجنبیوں کے ساتھ کسی فائل کے ٹکڑوں کا تبادلہ کر سکتا ہے، بیچ میں کوئی سرور نہیں۔

ہم نے صرف یہ دعویٰ نہیں کیا کہ یہ اصل ہے — ہم نے اسے ثابت کیا۔ Aether کو **MonoTorrent** کے خلاف جانچا گیا، جو دوسرے لوگوں کی بنائی ہوئی ایک پختہ، آزاد BitTorrent لائبریری ہے: ایک ہی فائل دیے جانے پر، دونوں *یکساں* فنگر پرنٹ تیار کرتے ہیں، لہٰذا کوئی بھی اصل ٹورنٹ کلائنٹ Aether کو اپنے ہی جیسا سمجھتا ہے۔ کوئی بھی ایک اصل BitTorrent کلائنٹ کو اس کی طرف اشارہ کر کے خود دیکھ سکتا ہے۔

اس کے اوپر، Aether ایک **برج** شامل کرتا ہے: انٹرنیٹ والا ایک نوڈ وسیع تر ویب سے ایک ٹورنٹ کھینچ سکتا ہے، اس کے ٹکڑوں کو Aether کے اپنے خفیہ میش چنکس کے طور پر دوبارہ-پیک کر سکتا ہے، اور اسے آگے شیئر کر سکتا ہے — تاکہ **بالکل بھی انٹرنیٹ نہ رکھنے والا** کوئی شخص پھر بھی وہ فائل آف لائن میش کے آر پار وصول کر سکے۔ نکتہ یہی ہے: دنیا کے سب سے بڑے فائل-شیئرنگ نیٹ ورک کو اُن لوگوں سے جوڑ دیں جن تک یہ عام طور پر نہیں پہنچ سکتا۔

**یہ کہاں کھڑا ہے، ایمانداری سے۔** BitTorrent کے *فارمیٹس* — ایک ٹورنٹ کو کیسے بیان کیا جاتا ہے، فنگر پرنٹ کیا جاتا ہے، اور وائر پر فریم کیا جاتا ہے — بنائے جا چکے ہیں اور **تمام 8 زبانوں میں بائٹ در بائٹ یکساں** ہیں، جو `fixtures/bittorrent/` میں ایک مشترکہ فکسچر کارپس سے منسلک ہیں۔ مکمل کارآمد کلائنٹ اور میش برج **C# ریفرنس** میں مکمل اور تصدیق شدہ ہیں؛ باقی سات زبانیں یکساں پروٹوکول فارمیٹس رکھتی ہیں، جن کی لائیو نیٹ ورک پرت اگلا قدم ہے۔

> **ڈویلپرز کے لیے۔** احاطہ: bencode + `.torrent`/magnet + SHA-1 info-hash اور BEP-3 peer-wire (rarest-first)، HTTP + UDP ٹریکرز (BEP-3/15/23)، Mainline DHT + PEX + ut_metadata (BEP-5/11/9/10)، µTP (BEP-29)، اور BitTorrent v2 SHA-256 merkle (BEP-52)، نیز مواد سروس میں ایک piece↔chunk **گیٹ وے** اور ایک بیک وقت، دوبارہ-قابلِ آغاز سیگمنٹڈ ڈاؤن لوڈر۔ C# ریفرنس (`src/AetherNet.BitTorrent`، `src/AetherNet.BitTorrent.Gateway`) لائیو TCP/µTP کلائنٹ، DHT نوڈ، ٹریکرز، گیٹ وے، اور ڈاؤن لوڈر شپ کرتا ہے، جس میں MonoTorrent انٹرآپ ٹیسٹ `tests/AetherNet.BitTorrent.Interop.Tests` میں ہے۔ 8-زبان بائٹ-یکسانیت کارپس (`fixtures/bittorrent/vectors.json`، 7 اقسام) bencode، info-hash، peer-wire، µTP، merkle، compact-info، اور KRPC کا احاطہ کرتا ہے؛ ہر SDK ایک مطابق فکسچر ٹیسٹ شپ کرتا ہے۔

## سیکیورٹی اور رازداری

وائر-سروس سویٹ کے علاوہ، Aether ایک چھوٹی **سیکیورٹی اور رازداری کی پرت** بھی فراہم کرتی ہے — شناختی-کلید کا انتظام اور link-layer کی سطح پر انسدادِ ٹریکنگ۔ باقی ہر چیز کی طرح، ہر ایک کو **تمام 8 زبانوں میں** نافذ کیا گیا ہے اور `fixtures/<feature>/` کے تحت ایک مشترکہ کراس-لینگویج فکسچر سے منسلک کیا گیا ہے (Swift اور C کو مزید برآں macOS build server پر تصدیق کیا گیا ہے)۔ یہ 18 وائر سروسز میں سے مزید چار *نہیں* ہیں: تین تو کوئی **نئی وائر پیکٹ قسم بالکل بھی متعین نہیں** کرتیں، اور چوتھی اپنے envelopes کو ایک نئی محفوظ شدہ پیکٹ کے بجائے **موجودہ DTN/mesh راستے کے اندر** لے جاتی ہے۔

| صلاحیت | یہ کیا کرتی ہے | پرت | فکسچر | 8/8 |
|---|---|---|---|:-:|
| **ریکوری-فریز بیک اپ** | کسی شناخت کا **24-الفاظ BIP-39** فریز کے طور پر بیک اپ لیں اور کسی بھی ڈیوائس پر بحال کریں۔ معیاری BIP-39 (سرکاری Trezor ویکٹرز کے خلاف تصدیق شدہ)، SHA-256-چیک سم شدہ تاکہ غلط ٹائپ کیا گیا لفظ *مسترد* ہو، کبھی خاموشی سے غلط نہ ہو۔ کوئی server نہیں، کوئی نگہبان نہیں — فریز **ہی** شناخت ہے۔ | مقامی | `fixtures/bip39/` | ✅ |
| **Bluetooth ٹریکنگ-تحفظ** | ایک گھومتی ہوئی، کلید سے اخذ کردہ BLE **Service UUID** (HMAC-SHA256، 15-منٹ کی ونڈو) اور **resolvable private addresses** (IRK + RFC `ah` فنکشن، AES-128) اخذ کرتی ہے — وہ انسدادِ ٹریکنگ مواد جو ایک BLE advertiser کو درکار ہوتا ہے تاکہ ایک غیر فعال سکینر اسے وقت یا مقام کے پار جوڑ نہ سکے۔ | link-layer | `fixtures/bleprivacy/` | ✅ |
| **Panic-wipe** | ایک **duress PIN** (SHA-256، constant-time موازنہ) جو، جبر کے تحت، ہر شناختی کلید کو محفوظ طریقے سے مٹا دیتی ہے — random-سے-اوور رائٹ پھر صفر — بحالی کے لیے کچھ باقی نہ چھوڑتے ہوئے۔ | مقامی | `fixtures/panicwipe/` | ✅ |
| **ملٹی-ڈیوائس sync** | آپ کی *اپنی* ڈیوائسز کے درمیان **غیر مرکزی، server کے بغیر** sync: ایک Ed25519-دستخط شدہ **DeviceLink** انہیں جوڑتی ہے، اور last-write-wins **SyncRecord** envelopes حالت کو ہم آہنگ کرتے ہیں — کسی cloud اکاؤنٹ اور کسی sync server کے بغیر، موجودہ DTN/mesh پر E2E-مرموز حالت میں لے جائے گئے۔ | DTN پر سوار ہوتی ہے | `fixtures/sync/` | ✅ |

**ایک ایماندارانہ عدم توازن۔** ملٹی-ڈیوائس **DeviceLink** Ed25519-دستخط شدہ ہے، اور وہ دستخط **8 میں سے 7 زبانوں میں بائٹ کے لحاظ سے یکساں** ہے۔ Apple کا CryptoKit جان بوجھ کر Ed25519 دستخطوں کو *randomize* کرتا ہے، اس لیے Swift پر 64 دستخط بائٹ ہر بار مختلف ہوتے ہیں — لیکن **دستخط شدہ باڈی بائٹ کے لحاظ سے یکساں ہے** اور ہر link اب بھی تمام 8 SDKs پر تصدیق ہوتی ہے، چنانچہ Swift دستخط-بائٹ برابری کے بجائے **تصدیق** کی برابری تک پہنچتی ہے۔ یہ ایک platform-crypto خاصیت ہے، نقص نہیں، اور ان چار خصوصیات میں یہی واحد جگہ ہے جہاں "بائٹ کے لحاظ سے یکساں" پر ستارہ (asterisk) لگتا ہے۔ مکمل وائر فارمیٹس [`PROTOCOL_SPEC.md`](../../PROTOCOL_SPEC.md) §12 میں ہیں؛ threat model [`THREAT_MODEL.md`](../../THREAT_MODEL.md) میں ہے۔
...
| زبان | ڈائریکٹری | وائر فارمیٹ | روٹنگ/DTN/SOS | X3DH | Double Ratchet | OPK پول | آواز/گروپ | اسٹریمنگ/ویڈیو/واچ | BitTorrent |
|----------|-----------|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| C# (.NET 10) | `src/` | ✅ | ✅ | ✅ | ✅ | ✅ (100) | ✅ | ✅ | ✅ |
| Rust | `rust/` | ✅ | ✅ | ✅ | ✅ | ✅ (100) | ✅ | ✅ | ◐ |
...
**BitTorrent کالم:** ✅ = مکمل، کارآمد کلائنٹ + میش گیٹ وے (C# ریفرنس)۔ ◐ = BitTorrent کے **وائر فارمیٹس** یہاں بائٹ در بائٹ یکساں ہیں (`fixtures/bittorrent/` سے منسلک)، جن کی لائیو نیٹ ورک پرت اگلا قدم ہے — دیکھیں [BitTorrent — اصل، اور میش میں برج کے ذریعے جُڑا](#bittorrent-bridge)۔ باقی ہر کالم تمام 8 زبانوں میں اصل اور کارآمد ہے۔

تمام 8 زبانیں بائٹ-یکساں وائر پیکٹس تیار کرتی ہیں، جن کی تصدیق 17 کینونیکل وائر-فارمیٹ فکسچرز اور 6 Signal ٹیسٹ ویکٹرز کے مقابلے میں ہوتی ہے (`fixtures/expected/*.bin`، `fixtures/signal/expected/*.json`) — ہر زبان کو انہی بائٹس کے خلاف جانچا جاتا ہے۔ روٹنگ (AODV-طرز RREQ/RREP)، DTN اسٹور-اینڈ-فارورڈ، SOS نشریہ، آواز، اسٹریمنگ، اور سیکیورٹی-سختی سروسز ہر زبان میں **~3,000 ٹیسٹس** کے ساتھ تمام 8 نفاذ میں نافذ ہیں:

| زبان | ٹیسٹس | ٹیسٹ پلیٹ فارم |
|----------|------:|-------------|
| C# (.NET 10) | 530 | Linux |
...
- وائر فارمیٹ: 8 زبانوں کے آر پار بائٹ-یکساں، 17 کینونیکل فکسچرز اور کراس-لینگویج تصدیقات سے منسلک (`fixtures/expected/*.bin`)
- **GitHub Actions ورک فلو (متعین کردہ، موجودہ گیٹ نہیں)** — ایک 9-جاب میٹرکس (C#/.NET 10، Go 1.22، TypeScript/Node 20، Python 3.12، Kotlin/JVM 21، Swift/macOS، Rust stable، C/GCC، نیز ایک فکسچر-سالمیت جاب) `.github/workflows/ci.yml` میں متعین ہے۔ کمٹس اِس وقت `[skip ci]` کے ساتھ پُش کیے جاتے ہیں، لہٰذا اصل نفاذ وہ فکسچر کارپس ہے جو **مقامی طور پر، فی زبان** چلایا جاتا ہے (Swift اور C کو macOS بلڈ سرور پر)؛ CI کو بغیر کوڈ تبدیلی کے دوبارہ آن کیا جا سکتا ہے۔
...
- **~3,000 ٹیسٹس** تمام 8 زبانوں کے آر پار (C# 530، TypeScript 459، Kotlin 457، Go 423، Python 387، Swift 295، C 253، Rust ~195) — سب ہرے، فی زبان چلائے گئے (Swift اور C کو macOS بلڈ سرور پر)
...
**کیا AetherNet انٹرنیٹ کے بغیر کام کرتا ہے؟**
جی ہاں — یہ آف لائن-فرسٹ ہے۔ آلات براہِ راست بلوٹوتھ، Wi-Fi Direct، NearLink، یا LoRa پر بات کرتے ہیں اور پیغامات کو دوسرے آلات سے ہوتے ہوئے قدم بہ قدم ریلے کرتے ہیں، بغیر کسی انٹرنیٹ کنکشن، سیل ٹاور، یا سرور کی ضرورت کے۔ جب کوئی لائیو روٹ موجود نہ ہو، تو پیغامات ایک راستہ کھلنے تک 72 گھنٹے تک روکے رکھے جاتے ہیں (تاخیر-برداشت کرنے والا اسٹور-اینڈ-فارورڈ)۔

**کیا یہ اینڈ-ٹو-اینڈ خفیہ ہے؟**
جی ہاں۔ AetherNet اینڈ-ٹو-اینڈ خفیہ کاری کے لیے Signal پروٹوکول (X3DH کی-معاہدہ نیز X25519 پر Double Ratchet)، پیغام کے پے لوڈز کے لیے AES-256-GCM، اور ہر پیکٹ پر Ed25519 دستخط استعمال کرتا ہے۔ کسی پیغام کو ریلے کرنے والے آلات اسے پڑھ نہیں سکتے۔

**یہ کون سے ٹرانسپورٹس استعمال کرتا ہے؟**
Bluetooth LE، Wi-Fi Direct، NearLink (SLE)، ایک LoRa/CircleLink سیریل ریڈیو، ایک HTTP/QUIC ریلے، اور براہِ راست انٹرنیٹ پیئر-ٹو-پیئر کے لیے WebRTC۔ پروٹوکول خودکار طور پر ہر پیکٹ کے لیے کم ترین-پاور دستیاب ٹرانسپورٹ منتخب کرتا ہے اور اگلے پر واپس آ جاتا ہے۔

**یہ کن پروگرامنگ زبانوں میں دستیاب ہے؟**
آٹھ — C#، Rust، TypeScript، Python، Go، Kotlin، Swift، اور C۔ ہر نفاذ بائٹ-یکساں وائر پیکٹس تیار کرتا ہے، جسے ایک مشترکہ کراس-لینگویج فکسچر کارپس کے ذریعے نافذ کیا جاتا ہے جس کے خلاف ہر نفاذ کو جانچا جاتا ہے، لہٰذا ایک زبان کا بنایا ہوا پیکٹ کسی بھی دوسری زبان بغیر کسی تبدیلی کے ڈی کوڈ کر لیتی ہے۔

**یہ Meshtastic، Briar، یا Bridgefy سے کیسے مختلف ہے؟**
Meshtastic صرف-LoRa ہے؛ AetherNet ملٹی-ٹرانسپورٹ ہے (Bluetooth + Wi-Fi + NearLink + LoRa) اور پیغامات کے ساتھ ساتھ آواز، ویڈیو، اور اسٹریمنگ بھی لے جاتا ہے۔ Briar صرف-Android ہے اور Tor پر روٹ کرتا ہے؛ AetherNet کراس-پلیٹ فارم اور خالص میش ہے۔ بند SDKs کے برعکس، AetherNet MIT-لائسنس یافتہ ہے اور آٹھ زبانوں میں کھلے عام نافذ کیا گیا ہے۔ اوپر دیے گئے موازنہ ٹیبل میں تفصیلات ہیں۔

**کیا یہ پروڈکشن کے لیے تیار ہے؟**
پروٹوکول کی پرت — وائر فارمیٹ، Signal سیکیورٹی، روٹنگ، DTN اسٹور-اینڈ-فارورڈ، اور مکمل سروس سویٹ — تمام آٹھ زبانوں میں نافذ اور آزمائی گئی ہے۔ ریڈیو ٹرانسپورٹس وہاں اصل ہیں جہاں پلیٹ فارم کوڈ موجود ہو (Windows اور Android پر Bluetooth اور Wi-Fi، ہر جگہ WebRTC) اور دیگر جگہوں پر ہارڈویئر برنگ-اپ کے زیرِ التوا میدانی طور پر غیر تصدیق شدہ ہیں، جس کا سراغ ایمانداری سے `OPEN_ISSUES.md` میں رکھا گیا ہے۔ تعینات کرنے سے پہلے ہر سیکشن میں اسٹیٹس نوٹس پڑھیں۔

**یہ کس لائسنس کے تحت ہے؟**
MIT — تجارتی اور اوپن-سورس استعمال کے لیے مفت۔ دیکھیں [LICENSE](LICENSE)۔

**AetherNet کون بناتا ہے؟**
اسے The Geek Network کے میش ایکو سسٹم کے پسِ پردہ کھلے پروٹوکول کے طور پر تیار کیا جاتا ہے، جو جنوبی افریقہ میں ایسے مواصلات کے لیے بنایا گیا ہے جو موبائل ڈیٹا کے ساتھ یا اس کے بغیر کام کرتا ہے۔

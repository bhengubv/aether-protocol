...
**BitTorrent কলাম:** ✅ = সম্পূর্ণ, কার্যকর ক্লায়েন্ট + মেশ গেটওয়ে (C# রেফারেন্স)। ◐ = BitTorrent **তার ফরম্যাটগুলো** এখানে বাইট-বাই-বাইট অভিন্ন (`fixtures/bittorrent/`-এ পিন করা), লাইভ নেটওয়ার্ক লেয়ার পরবর্তী ধাপ হিসেবে — দেখুন [BitTorrent — প্রকৃত, এবং মেশে সেতুবদ্ধ](#bittorrent--real-and-bridged-into-the-mesh)। বাকি প্রতিটি কলাম সব ৮টি ভাষায় প্রকৃত ও কার্যকর।

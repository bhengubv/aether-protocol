...
> **একটি প্রোটোকল, আটটি ভাষা, তারে হুবহু অভিন্ন।** Aether বাস্তবায়িত হয়েছে **C#, Rust, TypeScript, Python, Go, Kotlin, Swift, এবং C**-তে — এবং প্রতিটি প্যাকেট এই সবগুলোর মধ্যে বাইট-বাই-বাইট অভিন্ন, যা একটি ভাগ করা ক্রস-ল্যাঙ্গুয়েজ ফিক্সচার কর্পাস দিয়ে বলবৎ করা হয় যার সঙ্গে প্রতিটি বাস্তবায়নকে অবশ্যই বাইট-বাই-বাইট মিলতে হবে। এই আটটির যেকোনো একটিতে আপনার নোড তৈরি করুন; এটি বাকি সবগুলোর সঙ্গে আন্তঃপরিচালনযোগ্য। এই README ২০টি মানব ভাষাতেও উপলব্ধ (উপরের লিংকগুলো দেখুন)।

## সহজ কথায়

**AetherNet ফোন এবং ল্যাপটপগুলোকে একে অপরের সঙ্গে সরাসরি কথা বলতে দেয় — কোনো ইন্টারনেট, কোনো ফোন কোম্পানি, এবং কোনো অ্যাকাউন্ট ছাড়াই।** আপনার চারপাশের মানুষদের কাছে যদি অ্যাপটি থাকে, আপনি তাদের বার্তা পাঠাতে পারেন, ছবি ও বড় ফাইল পাঠাতে পারেন, ভয়েস ও ভিডিও কল করতে পারেন, এবং একটি লাইভ স্ট্রিম ভাগ করতে পারেন, শুধুমাত্র প্রতিটি ফোনের ভেতরে ইতিমধ্যে থাকা স্বল্প-পাল্লার রেডিও (Bluetooth এবং Wi-Fi) ব্যবহার করে। কেউ যদি সরাসরি নাগালের জন্য খুব দূরে থাকে, আপনার বার্তা নীরবে একটি ফোন থেকে পরেরটিতে লাফিয়ে যায় যতক্ষণ না এটি পৌঁছায় — এবং প্রয়োজন হলে একটি পথের জন্য তিন দিন পর্যন্ত অপেক্ষা করে। এটি এমনকি বিশ্বের বড় সর্বজনীন ফাইল-শেয়ারিং নেটওয়ার্কগুলোতে (Linux এবং গেম আপডেটের মতো বৈধ ডাউনলোডের পেছনের একই প্রযুক্তি) পৌঁছাতে পারে, একটি ফাইল টেনে আনতে পারে, এবং যার কোনো ইন্টারনেটই নেই এমন একজন বন্ধুর কাছে এটি ভেতরের দিকে বহন করতে পারে।

সবকিছু এন্ড-টু-এন্ড এনক্রিপ্ট করা, তাই শুধুমাত্র আপনি যার সঙ্গে কথা বলছেন সেই ব্যক্তিই এটি পড়তে পারে — যে ফোনগুলো এটি এগিয়ে দিচ্ছে সেগুলো পারে না। এটি যে কারও ব্যবহার বা পরিদর্শনের জন্য **বিনামূল্যে এবং উন্মুক্ত**, এবং এটি আট বার করে লেখা, আটটি প্রোগ্রামিং ভাষায়, যাতে এটি প্রায় যেকোনো ডিভাইসে চলতে পারে।

**এটি কতটা সম্পূর্ণ?** নেটওয়ার্কের "মস্তিষ্ক" — বার্তা ফরম্যাট, এনক্রিপশন, রাউটিং, এবং ফাইল-শেয়ারিং — সব আটটি ভাষা জুড়ে নির্মিত ও মেশিন-যাচাইকৃত। যা এখনও বাস্তব-বিশ্বে পরীক্ষার প্রয়োজন তা হলো দুটি ভৌত ফোনের মধ্যে বাতাসের ওপর দিয়ে একে অপরের সঙ্গে কথা বলা প্রকৃত রেডিওগুলো; সেই হার্ডওয়্যার ধাপটিই বাকি, এবং আমরা এটি `OPEN_ISSUES.md`-এ খোলাখুলিভাবে ট্র্যাক করি। নিচের সবকিছু আরও বিস্তারিতভাবে একই গল্প।
...
**পুরো ইন্টারনেট ইতিমধ্যে যেভাবে বড় ফাইল ভাগ করে সেভাবেই একটি বড় ফাইল পান।**

BitTorrent হলো বিশ্বের বৈধ ফাইল-শেয়ারিংয়ের একটি বিশাল অংশের পেছনের প্রযুক্তি — Linux রিলিজ, গেম আপডেট, Internet Archive। Aether এখন এটি *সত্যিকারভাবে* বলে: একটি Aether নোড একটি সাধারণ BitTorrent swarm-এ যোগ দিতে পারে এবং কোনো কেন্দ্রীয় সার্ভার ছাড়াই সরাসরি জনতার কাছ থেকে একটি ফাইল টেনে আনতে পারে। এবং যাদের কোনো ডেটা নেই তাদের জন্য এখানে চমকটি হলো — যে একটি Aether নোডের *সত্যিই* ইন্টারনেট আছে সেটি একটি টরেন্ট আনতে পারে এবং **অফলাইন মেশ জুড়ে এটি পুনরায় ভাগ করতে পারে**, যাতে সম্পূর্ণ অফলাইন একজন বন্ধুও Bluetooth এবং Wi-Fi-এর ওপর দিয়ে হপ বাই হপ ফাইলটি পায়। বিশ্বের বৃহত্তম ফাইল-শেয়ারিং নেটওয়ার্ক, ইন্টারনেট যাদের কাছে পৌঁছায় না তাদের কাছে পৌঁছাচ্ছে।
...
## BitTorrent — প্রকৃত, এবং মেশে সেতুবদ্ধ

Aether-এ এখন একটি **প্রকৃত, আন্তঃপরিচালনযোগ্য BitTorrent বাস্তবায়ন** অন্তর্ভুক্ত — প্রকৃত টরেন্ট ক্লায়েন্টরা যে আসল প্রোটোকল ব্যবহার করে সেটিই, কোনো নকল নয়। তাই একটি Aether নোড একটি সাধারণ swarm-এ যোগ দিতে পারে এবং মাঝখানে কোনো সার্ভার ছাড়াই ইন্টারনেটে অপরিচিতদের সঙ্গে একটি ফাইলের টুকরো আদান-প্রদান করতে পারে।

আমরা শুধু দাবি করিনি যে এটি প্রকৃত — আমরা এটি প্রমাণ করেছি। Aether-কে **MonoTorrent**-এর বিপরীতে যাচাই করা হয়েছে, যা অন্যদের দ্বারা তৈরি একটি পরিপক্ব, স্বাধীন BitTorrent লাইব্রেরি: একই ফাইল দিলে, উভয়ই *অভিন্ন* ফিঙ্গারপ্রিন্ট তৈরি করে, তাই যেকোনো প্রকৃত টরেন্ট ক্লায়েন্ট Aether-কে তার নিজেরই একজন হিসেবে গণ্য করে। যে কেউ এটির দিকে একটি প্রকৃত BitTorrent ক্লায়েন্ট তাক করে নিজে দেখে নিতে পারে।

এর ওপরে, Aether একটি **সেতু** যোগ করে: ইন্টারনেট সহ একটি নোড বৃহত্তর ওয়েব থেকে একটি টরেন্ট টেনে আনতে পারে, এর টুকরোগুলোকে Aether-এর নিজস্ব এনক্রিপ্ট করা মেশ চাঙ্ক হিসেবে পুনরায় প্যাকেজ করতে পারে, এবং এটি এগিয়ে ভাগ করতে পারে — যাতে **যার কোনো ইন্টারনেটই নেই** এমন কেউ অফলাইন মেশ জুড়ে সেই ফাইলটি পেতে পারে। এটাই মূল কথা: বিশ্বের বৃহত্তম ফাইল-শেয়ারিং নেটওয়ার্ককে সেই মানুষদের সঙ্গে যুক্ত করা যাদের কাছে এটি সাধারণত পৌঁছাতে পারে না।

**এটি সৎভাবে কোথায় দাঁড়িয়ে।** BitTorrent *ফরম্যাটগুলো* — কীভাবে একটি টরেন্ট বর্ণিত, ফিঙ্গারপ্রিন্ট করা, এবং তারে ফ্রেম করা হয় — নির্মিত এবং **সব ৮টি ভাষায় বাইট-বাই-বাইট অভিন্ন**, `fixtures/bittorrent/`-এ একটি ভাগ করা ফিক্সচার কর্পাসে পিন করা। সম্পূর্ণ কার্যকর ক্লায়েন্ট এবং মেশ সেতু **C# রেফারেন্সে** সম্পূর্ণ ও যাচাইকৃত; বাকি সাতটি ভাষা অভিন্ন প্রোটোকল ফরম্যাট বহন করে, তাদের লাইভ নেটওয়ার্ক লেয়ার পরবর্তী ধাপ হিসেবে।

> **ডেভেলপারদের জন্য।** কভারেজ: bencode + `.torrent`/magnet + SHA-1 info-hash এবং BEP-3 peer-wire (rarest-first), HTTP + UDP ট্র্যাকার (BEP-3/15/23), Mainline DHT + PEX + ut_metadata (BEP-5/11/9/10), µTP (BEP-29), এবং BitTorrent v2 SHA-256 merkle (BEP-52), সঙ্গে কনটেন্ট সার্ভিসে একটি piece↔chunk **গেটওয়ে** এবং একটি সমসাময়িক, পুনঃসূচনাযোগ্য সেগমেন্টেড ডাউনলোডার। C# রেফারেন্স (`src/AetherNet.BitTorrent`, `src/AetherNet.BitTorrent.Gateway`) লাইভ TCP/µTP ক্লায়েন্ট, DHT নোড, ট্র্যাকার, গেটওয়ে, এবং ডাউনলোডার শিপ করে, `tests/AetherNet.BitTorrent.Interop.Tests`-এ MonoTorrent ইন্টারঅপ টেস্ট সহ। ৮-ভাষার বাইট-অভিন্নতা কর্পাস (`fixtures/bittorrent/vectors.json`, ৭টি ক্যাটাগরি) bencode, info-hash, peer-wire, µTP, merkle, compact-info, এবং KRPC কভার করে; প্রতিটি SDK একটি মিলিত ফিক্সচার টেস্ট শিপ করে।
...
| ভাষা | ডিরেক্টরি | তার ফরম্যাট | রাউটিং/DTN/SOS | X3DH | Double Ratchet | OPK পুল | ভয়েস/গ্রুপ | স্ট্রিমিং/ভিডিও/ওয়াচ | BitTorrent |
|----------|-----------|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| C# (.NET 10) | `src/` | ✅ | ✅ | ✅ | ✅ | ✅ (100) | ✅ | ✅ | ✅ |
| Rust | `rust/` | ✅ | ✅ | ✅ | ✅ | ✅ (100) | ✅ | ✅ | ◐ |
...
**BitTorrent কলাম:** ✅ = সম্পূর্ণ, কার্যকর ক্লায়েন্ট + মেশ গেটওয়ে (C# রেফারেন্স)। ◐ = BitTorrent **তার ফরম্যাটগুলো** এখানে বাইট-বাই-বাইট অভিন্ন (`fixtures/bittorrent/`-এ পিন করা), লাইভ নেটওয়ার্ক লেয়ার পরবর্তী ধাপ হিসেবে — দেখুন [BitTorrent — প্রকৃত, এবং মেশে সেতুবদ্ধ](#bittorrent-bridge)। বাকি প্রতিটি কলাম সব ৮টি ভাষায় প্রকৃত ও কার্যকর।

সব ৮টি ভাষা বাইট-অভিন্ন তার প্যাকেট তৈরি করে, ১৭টি ক্যানোনিক্যাল তার-ফরম্যাট ফিক্সচার এবং ৬টি Signal টেস্ট ভেক্টর দিয়ে যাচাইকৃত (`fixtures/expected/*.bin`, `fixtures/signal/expected/*.json`) — **প্রতিটি ভাষা একই বাইটের বিপরীতে যাচাই করা হয়**। রাউটিং (AODV-স্টাইল RREQ/RREP), DTN স্টোর-অ্যান্ড-ফরোয়ার্ড, SOS সম্প্রচার, ভয়েস, স্ট্রিমিং, এবং নিরাপত্তা-শক্তিশালীকরণ সার্ভিস প্রতিটি ভাষায় বাস্তবায়িত সব ৮টি বাস্তবায়ন জুড়ে **~3,000 টেস্ট** সহ:

| ভাষা | টেস্ট | টেস্ট প্ল্যাটফর্ম |
|----------|------:|-------------|
| C# (.NET 10) | 530 | Linux |
...
তার ফরম্যাট এবং Signal-এর বাইরে, **সম্পূর্ণ তার-সার্ভিস স্যুট** — প্রেজেন্স, হার্টবিট, প্রোফাইল সিঙ্ক, ক্ষণস্থায়ী-ID ঘোষণা, প্রি-কি এক্সচেঞ্জ, চ্যানেল, পুশ-টু-টক, স্ক্রিন শেয়ার, কল কন্ট্রোল, SOS স্বীকৃতি, স্পেস ব্রেডক্রাম্ব, ফোর্জ ঘোষণা, ভল্ট শার্ড অনুরোধ, এবং ব্যান্ডউইথ পরিমাপ (দেখুন [**আপনি যা পান**](#what-you-get)) — একইভাবে সব ৮টি ভাষায় বাস্তবায়িত এবং নিজস্ব ফিক্সচারে পিন করা (`fixtures/presence/`, `fixtures/media/`, `fixtures/bandwidth/`, `fixtures/prekey/`, `fixtures/videocall/`, `fixtures/vaultshard/`, এবং সহোদর)। প্রোটোকল লেয়ারে কোনো ফিচার C#-শুধুমাত্র নয়।
...
- তার ফরম্যাট: ৮টি ভাষা জুড়ে বাইট-অভিন্ন, ১৭টি ক্যানোনিক্যাল ফিক্সচার এবং ক্রস-ল্যাঙ্গুয়েজ অ্যাসারশন দিয়ে নোঙর করা (`fixtures/expected/*.bin`)
- **GitHub Actions workflow (সংজ্ঞায়িত, বর্তমান গেট নয়)** — একটি ৯-জব ম্যাট্রিক্স (C#/.NET 10, Go 1.22, TypeScript/Node 20, Python 3.12, Kotlin/JVM 21, Swift/macOS, Rust stable, C/GCC, সঙ্গে একটি ফিক্সচার-ইন্টিগ্রিটি জব) `.github/workflows/ci.yml`-এ সংজ্ঞায়িত। কমিটগুলো বর্তমানে `[skip ci]` সহ পুশ করা হয়, তাই প্রকৃত বলবৎকরণ হলো ফিক্সচার কর্পাস **স্থানীয়ভাবে, প্রতি ভাষায়** চালানো (Swift এবং C macOS বিল্ড সার্ভারে); কোড পরিবর্তন ছাড়াই CI আবার চালু করা যায়।
...
- সব ৮টি ভাষা জুড়ে **~3,000 টেস্ট** (C# 530, TypeScript 459, Kotlin 457, Go 423, Python 387, Swift 295, C 253, Rust ~195) — সব সবুজ, প্রতি ভাষায় চালানো (Swift এবং C macOS বিল্ড সার্ভারে)
...
আটটি — C#, Rust, TypeScript, Python, Go, Kotlin, Swift, এবং C। প্রতিটি বাস্তবায়ন বাইট-অভিন্ন তার প্যাকেট তৈরি করে, যা একটি ভাগ করা ক্রস-ল্যাঙ্গুয়েজ ফিক্সচার কর্পাস দিয়ে বলবৎ করা হয় যার বিপরীতে প্রতিটি বাস্তবায়ন যাচাই করা হয়, তাই একটি ভাষা দ্বারা তৈরি একটি প্যাকেট অন্য যেকোনো ভাষা দ্বারা অপরিবর্তিতভাবে ডিকোড করা হয়।

...
Ngaphandle kwesethi yensiza ye-wire, i-Aether ithumela **ingqimba encane yezokuphepha nobumfihlo** — ukuphathwa kokhiye bobunikazi kanye nokuvikela ukulandelelwa ezingeni le-link-layer. Njengakho konke okunye, ngayinye yenziwe **kuzo zonke izilimi eziyi-8** futhi iboshelwe ku-fixture esatshalaliswa phakathi kwezilimi ngaphansi kwe-`fixtures/<feature>/` (i-Swift ne-C ngaphezu kwalokho ziqinisekiswa ku-macOS build server). Lezi *aziyona* ezinye ezine zezinsiza ze-wire eziyi-18: ezintathu **azichazi uhlobo olusha lwephakethe le-wire** nhlobo, futhi eyesine ithwala ama-envelope ayo **ngaphakathi kwendlela ye-DTN/mesh ekhona** kunokuba ibe iphakethe elisha eligodliwe.

| Ikhono | Kwenzani | Ingqimba | I-Fixture | 8/8 |
|---|---|---|---|:-:|
| **Isipele se-recovery-phrase** | Enza isipele sobunikazi njengebinzana le-**24-word BIP-39** bese ubuyisela kunoma iyiphi idivayisi. I-BIP-39 ejwayelekile (iqinisekiswe maqondana nama-vector we-Trezor asemthethweni), ine-checksum ye-SHA-256 ukuze igama elibhalwe ngephutha *linqatshwe*, lingalungi ngokuthula. Akukho iseva, akukho umgcini — ibinzana **yilo** ubunikazi. | endaweni | `fixtures/bip39/` | ✅ |
| **Ukuvikela ukulandelelwa kwe-Bluetooth** | Ikhiqiza i-BLE **Service UUID** ejikelezayo, etholwa kokhiye (HMAC-SHA256, i-window yemizuzu eyi-15) kanye **nama-resolvable private address** (IRK + umsebenzi we-RFC `ah`, AES-128) — into yokuvikela ukulandelelwa i-BLE advertiser eyidingayo ukuze isikena esinganaki singakwazi ukukuxhuma esikhathini nasendaweni. | i-link-layer | `fixtures/bleprivacy/` | ✅ |
| **I-Panic-wipe** | I-**duress PIN** (SHA-256, iqhathaniswa ngesikhathi esimile) ethi, ngaphansi kokuphoqelelwa, isule ngokuphepha wonke okhiye bobunikazi — bhalela phezu kwe-random bese kuba u-zero — kungasali lutho ongalubuyisa. | endaweni | `fixtures/panicwipe/` | ✅ |
| **Ukuvumelanisa amadivayisi amaningi** | Ukuvumelanisa **okusabalele, okungenaseva** kuwo *awakho* amadivayisi: i-**DeviceLink** esayinwe nge-Ed25519 iyawabhangqa, futhi ama-envelope e-**SyncRecord** we-last-write-wins avumelanisa isimo — athwalwa ebethelwe nge-E2E kuyo i-DTN/mesh ekhona, engenayo i-akhawunti ye-cloud futhi engenayo iseva yokuvumelanisa. | ikhwela i-DTN | `fixtures/sync/` | ✅ |

**Ukungalingani okukodwa okuqotho.** I-**DeviceLink** yamadivayisi amaningi isayinwe nge-Ed25519, futhi leso sisayino **siyafana ibhayithi ngebhayithi kwezi-7 kwezilimi eziyi-8**. I-CryptoKit ka-Apple *iyenza i-random* ngamabomu izisayino ze-Ed25519, ngakho ku-Swift amabhayithi esisayino angama-64 ahluka njalo — kodwa **umzimba osayiniwe uyafana ibhayithi ngebhayithi** futhi zonke izixhumanisi ziyaqinisekiswa kuzo zonke ama-SDK ayi-8, ngakho i-Swift ifinyelela i-parity **yokuqinisekiswa** kunokuba i-parity yebhayithi lesisayino. Leyo yimpahla ye-platform-crypto, hhayi isici, futhi yiyona ndawo kuphela kulezi zici ezine lapho "ukufana ibhayithi ngebhayithi" kuphethe u-asterisk. Amafomethi aphelele we-wire aku-[`PROTOCOL_SPEC.md`](../../PROTOCOL_SPEC.md) §12; i-threat model iku-[`THREAT_MODEL.md`](../../THREAT_MODEL.md).

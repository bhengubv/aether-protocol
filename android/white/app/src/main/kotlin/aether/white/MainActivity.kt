 ...
 *
 * The HCE service ([AetherHceService]) handles all NFC interactions automatically.
 ...
 */
class MainActivity : AppCompatActivity(), AetherHceService.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AetherHceService.listener = this
    ...
    override fun onDestroy() {
        AetherHceService.listener = null
        super.onDestroy()
    }

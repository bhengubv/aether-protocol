 ...
 *
 * The HCE service ([AetherNetHceService]) handles all NFC interactions automatically.
 ...
 */
class MainActivity : AppCompatActivity(), AetherNetHceService.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AetherNetHceService.listener = this
    ...
    override fun onDestroy() {
        AetherNetHceService.listener = null
        super.onDestroy()
    }

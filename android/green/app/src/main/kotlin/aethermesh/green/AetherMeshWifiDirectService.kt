...
private const val TAG      = "AetherMeshWFD"
...
class AetherMeshWifiDirectService(private val context: Context) {
    ...
    fun initialize() {
        ...
        notify("Wi-Fi Direct initialised. Service UUID: aethermesh.green")

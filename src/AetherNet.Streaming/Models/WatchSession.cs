...
/// <c>AetherNet.Content</c>) — the watch layer doesn't move bytes itself, it just
...
public sealed class WatchSession
{
    ...
    /// <summary>Root hash of the content being watched (typically published earlier via <c>AetherNet.Content</c>).</summary>
...
/// <summary>
/// Wire payload for <see cref="AetherNet.Protocol.PacketType.WatchSync"/>. Host emits
...
/// <summary>
/// Wire payload for <see cref="AetherNet.Protocol.PacketType.WatchReaction"/> — followers
...
/// <summary>
/// Wire payload for the announce / join handshake. Carried in <see cref="AetherNet.Protocol.PacketType.WatchSync"/>

...
/// <summary>
/// Root configuration for <c>services.AddAetherNetProtocol(...)</c>. Bind from
...
/// </summary>
public sealed class AetherNetOptions
{
    /// <summary>
...
/// suffix to disambiguate from the existing <c>AetherNet.Routing</c> types.
/// </summary>

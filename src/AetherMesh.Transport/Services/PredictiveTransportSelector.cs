...
public sealed class PredictiveTransportSelector
{
    ...
    ///   <item><description><see cref="IAetherMeshAiProvider.IsAvailable"/> is <c>false</c>.</description></item>
    ...
    ///
    /// <para>
    /// Bias semantics match <see cref="IAetherMeshAiProvider.GetTransportBiasesAsync"/>:
    ...
    public async Task<IReadOnlyList<(ITransportService Transport, double Score, double PredictedRttMs, double RttVariance)>>
        RankWithAiAsync(
            ...
            IAetherMeshAiProvider? aiProvider = null,

...
/// <c>AetherMesh.Content</c>) — the watch layer doesn't move bytes itself, it just
...
public sealed class WatchSession
{
    ...
    /// <summary>Root hash of the content being watched (typically published earlier via <c>AetherMesh.Content</c>).</summary>

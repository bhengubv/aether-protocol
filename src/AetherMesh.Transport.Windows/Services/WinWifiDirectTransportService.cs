...
public sealed class WinWifiDirectTransportService : IWifiDirectService, IAsyncDisposable
{
    ...
    private static readonly byte[] AetherMeshOui = [0xAE, 0x71, 0x48];
    private const byte   AetherMeshOuiType = 0x01;
    ...
    public void StartAdvertising()
    {
        ...
        ie.Oui      = CryptographicBuffer.CreateFromByteArray(AetherMeshOui);
        ie.OuiType  = AetherMeshOuiType;

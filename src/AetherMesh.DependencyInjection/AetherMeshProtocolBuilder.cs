...
/// <summary>
/// Sealed implementation of <see cref="IAetherMeshProtocolBuilder"/>. Tracks which
...
/// at first resolution.
/// </summary>
internal sealed class AetherMeshProtocolBuilder : IAetherMeshProtocolBuilder
{
    ...
    public AetherMeshProtocolBuilder(IServiceCollection services)
    {
    ...
    public IAetherMeshProtocolBuilder AddSignalProtocol()
    {
    ...
    public IAetherMeshProtocolBuilder AddRouting()
    {
        ...
        Services.TryAddSingleton<IRoutingService>(sp =>
        {
            ...
            var telemetry  = sp.GetService<IAetherMeshTelemetry>();
    ...
    public IAetherMeshProtocolBuilder AddDtn()
    {
    ...
    public IAetherMeshProtocolBuilder AddSosBroadcast()
    {
    ...
    public IAetherMeshProtocolBuilder AddMessaging()
    {
        if (!_signalAdded)
        {
        ...
        Services.TryAddSingleton<IMessagingService>(sp =>
        {
            ...
            var optionsBag = sp.GetRequiredService<IOptions<AetherMeshOptions>>().Value.Messaging;
    ...
    public IAetherMeshProtocolBuilder AddInProcessTransport(string localUhid)
    {
    ...
    public IAetherMeshProtocolBuilder AddHealthChecks()
    {
    ...
    public IAetherMeshProtocolBuilder AddHandshake()
    {
    ...
    public IAetherMeshProtocolBuilder AddReputation()
    {
    ...
    public IAetherMeshProtocolBuilder AddAnomalyDetector(Action<AnomalyDetectorOptions>? configure = null)
    {
        if (!_reputationAdded)
        {
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddGossip()
    {
        if (!_reputationAdded)
        {
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddStreaming()
    {
        if (!_routingAdded)
            throw new InvalidOperationException(
        ...
        Services.TryAddSingleton<IStreamingService>(sp =>
        {
            var sender    = sp.GetRequiredService<IMeshSender>();
            var routing   = sp.GetRequiredService<IRoutingService>();
            var incentives = sp.GetService<IAetherMeshIncentiveProvider>();
    ...
    public IAetherMeshProtocolBuilder AddWatchTogether()
    {
        if (!_routingAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddVideoCall()
    {
        if (!_routingAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddGroupVideo()
    {
        if (!_routingAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddVoice()
    {
        if (!_routingAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddGroupVoice()
    {
        if (!_routingAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddContent()
    {
        if (!_routingAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddSpace()
    {
        if (!_contentAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddForge()
    {
        if (!_contentAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddVault()
    {
        if (!_contentAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddMarket()
    {
        if (!_spaceAdded)
            throw new InvalidOperationException(
    ...
    public IAetherMeshProtocolBuilder AddTelemetry<T>() where T : class, IAetherMeshTelemetryObserver
    {
        // Not TryAdd — multiple observers are valid and additive.
        Services.AddSingleton<IAetherMeshTelemetryObserver, T>();
        return this;
    }

    public IAetherMeshProtocolBuilder AddTelemetry(IAetherMeshTelemetryObserver observer)
    {
    ...
    public IAetherMeshProtocolBuilder AddCircleAI<T>() where T : class, IAetherMeshAiProvider
    {
        Services.Replace(ServiceDescriptor.Singleton<IAetherMeshAiProvider, T>());
        return this;
    }

    public IAetherMeshProtocolBuilder AddCircleAI(IAetherMeshAiProvider provider)
    {
        ArgumentNullException.ThrowIfNull(provider);
        Services.Replace(ServiceDescriptor.Singleton(typeof(IAetherMeshAiProvider), provider));
        return this;
    }

    public IAetherMeshProtocolBuilder AddBiometrics<T>() where T : class, IBiometricProvider
    {
        Services.Replace(ServiceDescriptor.Singleton<IBiometricProvider, T>());
        return this;
    }

    public IAetherMeshProtocolBuilder AddBiometrics(IBiometricProvider provider)
    {
        ArgumentNullException.ThrowIfNull(provider);
    ...
    public IAetherMeshProtocolBuilder AddContextMemory<T>() where T : class, IAetherMeshContextMemory
    {
        Services.Replace(ServiceDescriptor.Singleton<IAetherMeshContextMemory, T>());
        return this;
    }

    public IAetherMeshProtocolBuilder AddContextMemory(IAetherMeshContextMemory memory)
    {
        ArgumentNullException.ThrowIfNull(memory);
        Services.Replace(ServiceDescriptor.Singleton(typeof(IAetherMeshContextMemory), memory));
        return this;
    }

    public IAetherMeshProtocolBuilder AddSecurityAudit<T>() where T : class, IAetherMeshSecurityAudit
    {
        Services.Replace(ServiceDescriptor.Singleton<IAetherMeshSecurityAudit, T>());
        return this;
    }

    public IAetherMeshProtocolBuilder AddSecurityAudit(IAetherMeshSecurityAudit auditor)
    {
        ArgumentNullException.ThrowIfNull(auditor);
        Services.Replace(ServiceDescriptor.Singleton(typeof(IAetherMeshSecurityAudit), auditor));
        return this;
    }
}

...
/// </para>
/// <code>
/// services.AddAetherProtocol(opts =>
///         {
...
/// </list>
/// </summary>
public static class AetherWindowsTransportExtensions
{
    /// <summary>
    ...
    public static IAetherProtocolBuilder AddWindowsTransports(
        this IAetherProtocolBuilder builder,
        string? httpRelayBaseUrl = null)
    {
        ...
        {
            var localUhid = sp.GetRequiredService<IOptions<AetherOptions>>().Value.LocalUhid;

...
public sealed class WinWifiDirectTransportService : IWifiDirectService, IAsyncDisposable
{
    ...
    private static readonly byte[] AetherOui = [0xAE, 0x71, 0x48];
    private const byte   AetherOuiType = 0x01;
    ...
    public void StartAdvertising()
    {
        ...
        ie.Oui      = CryptographicBuffer.CreateFromByteArray(AetherOui);
        ie.OuiType  = AetherOuiType;

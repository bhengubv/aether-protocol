...
{
    /// <summary>Codec identifier matched against <see cref="AetherNet.Voice.Models.VoiceSignalingMessage.ProposedCodecs"/> ("opus", "speex", "pcm-passthrough", …).</summary>
    string Name { get; }
...
public sealed class PassThroughVoiceCodec : IVoiceCodec
{
    ...
    public PassThroughVoiceCodec(int sampleRateHz = 16_000, int frameDurationMs = AetherNet.Constants.ProtocolConstants.VoiceFrameDurationMs)
    {

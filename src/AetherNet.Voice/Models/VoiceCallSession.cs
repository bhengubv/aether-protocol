...
public sealed class VoiceCallSession
{
    ...
    /// <summary>Frame duration in ms (typically <see cref="AetherNet.Constants.ProtocolConstants.VoiceFrameDurationMs"/>).</summary>
    public int FrameDurationMs { get; set; } = AetherNet.Constants.ProtocolConstants.VoiceFrameDurationMs;

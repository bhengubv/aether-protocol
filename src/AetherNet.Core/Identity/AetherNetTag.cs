...
/// </summary>
public readonly struct AetherNetTag : IEquatable<AetherNetTag>
{
    // ── Crockford base-32 ────────────────────────────────────────────────────
    ...
    private AetherNetTag(string value) => Value = value;
    ...
    public static AetherNetTag FromPublicKey(byte[] publicKey)
    {
        ...
        return new AetherNetTag(formatted);
    }
    ...
    public static AetherNetTag Parse(string tag)
    {
    ...
    /// </summary>
    public static bool TryParse(string? tag, out AetherNetTag result)
    {
        result = default;
        ...
        result = new AetherNetTag(formatted);
        return true;
    }
    ...
    public bool Equals(AetherNetTag other) =>
        string.Equals(Value, other.Value, StringComparison.Ordinal);

    public override bool Equals(object? obj) =>
        obj is AetherNetTag other && Equals(other);

    public override int GetHashCode() =>
        Value?.GetHashCode(StringComparison.Ordinal) ?? 0;

    public static bool operator ==(AetherNetTag left, AetherNetTag right) => left.Equals(right);
    public static bool operator !=(AetherNetTag left, AetherNetTag right) => !left.Equals(right);
    ...
    public static implicit operator string(AetherNetTag tag) => tag.ToString();
}

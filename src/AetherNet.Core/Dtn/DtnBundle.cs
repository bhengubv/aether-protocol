...
public sealed class DtnBundle
{
    ...
    public int MaxCopies { get; set; } = AetherNet.Constants.ProtocolConstants.DtnMaxCopies;
    ...
    public DateTime ExpiresAt { get; set; } = DateTime.UtcNow.AddHours(AetherNet.Constants.ProtocolConstants.DtnBundleTtlHours);

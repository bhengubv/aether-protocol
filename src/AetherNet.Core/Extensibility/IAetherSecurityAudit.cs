...
//    hunt-auth-bypass       → AetherNetVulnerabilityClass.AuthBypass
//    hunt-race-condition    → AetherNetVulnerabilityClass.RaceCondition
//    hunt-idor              → AetherNetVulnerabilityClass.InformationDisclosure
//    hunt-rce               → AetherNetVulnerabilityClass.RemoteCodeExecution
//    hunt-business-logic    → AetherNetVulnerabilityClass.BusinessLogic (Sybil, free-rider)
//    hunt-api-misconfig     → AetherNetVulnerabilityClass.ProtocolMisconfiguration
//    hunt-ssrf              → AetherNetVulnerabilityClass.RelayAbuse
//    hunt-dos               → AetherNetVulnerabilityClass.DenialOfService
//    supply-chain-attack-recon → AetherNetVulnerabilityClass.SupplyChain
// ─────────────────────────────────────────────────────────────────────────────
...
/// </summary>
public enum AetherNetVulnerabilityClass : byte
{
    /// <summary>
...
/// <summary>
/// A single security finding produced by <see cref="IAetherNetSecurityAudit"/>.
/// </summary>
...
public sealed record AetherNetAuditFinding(
    string                   Id,
    AetherNetVulnerabilityClass VulnerabilityClass,
...
/// taxonomy (<see cref="AetherNetVulnerabilityClass"/>). Three intended callers:
/// </para>
/// <list type="number">
...
/// <see cref="NullAetherNetSecurityAudit"/> is used — all audits return empty finding lists
...
/// </para>
/// </summary>
public interface IAetherNetSecurityAudit
{
    /// <summary>
    ...
    Task<IReadOnlyList<AetherNetAuditFinding>> AuditPacketsAsync(
        IReadOnlyList<MeshPacket> packets,
        CancellationToken         cancellationToken = default)
        => Task.FromResult<IReadOnlyList<AetherNetAuditFinding>>([]);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<IReadOnlyList<AetherNetAuditFinding>> AuditNodeAsync(
        string            nodeId,
        CancellationToken cancellationToken = default)
        => Task.FromResult<IReadOnlyList<AetherNetAuditFinding>>([]);
    ...
    /// </summary>
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<IReadOnlyList<AetherNetAuditFinding>> AuditProtocolConfigAsync(
        CancellationToken cancellationToken = default)
        => Task.FromResult<IReadOnlyList<AetherNetAuditFinding>>([]);
}

/// <summary>
/// No-op <see cref="IAetherNetSecurityAudit"/> — returns empty findings for all audits.
/// </summary>
public sealed class NullAetherNetSecurityAudit : IAetherNetSecurityAudit
{

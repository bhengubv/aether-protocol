...
/// Returned by <see cref="IAetherNetAiProvider.GetNetworkHealthAsync"/>.
///
/// <para>
...
/// temporarily degraded. <see cref="NullAetherNetAiProvider"/> is the registered
/// default and serves as the canonical reference implementation of this contract.
/// </para>
/// </summary>
public interface IAetherNetAiProvider
{
    /// <summary>

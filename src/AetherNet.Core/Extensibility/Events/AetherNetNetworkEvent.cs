...
public enum AetherNetNetworkEventKind : byte
{
...
/// <see cref="AetherNetNodeEvent"/> and <see cref="AetherNetRouteEvent"/> feeds
...
public sealed record AetherNetNetworkEvent(
    AetherNetNetworkEventKind Kind,
    int                    NodeCount,

...
public enum AetherNetRouteEventKind : byte
{
...
/// <see cref="IAetherNetAiProvider.SuggestRoutesAsync"/> recommendations.
/// </para>
/// </summary>
...
/// <param name="FailureReason">Human-readable reason for a <see cref="AetherNetRouteEventKind.Failed"/> event; <c>null</c> otherwise.</param>
/// <param name="OccurredAt">UTC timestamp of the event.</param>
public sealed record AetherNetRouteEvent(
    string                 SourceNodeId,
    string                 DestinationNodeId,
    IReadOnlyList<string>  Path,
    AetherNetRouteEventKind   Kind,
    ...
    DateTimeOffset         OccurredAt)
{
    ...
    public bool IsFailed => Kind is AetherNetRouteEventKind.Failed;
}

...
/// these events via <see cref="IAetherNetTelemetry"/>.
/// </para>
/// </summary>
public enum AetherNetThreatLevel : byte
{
...
/// </summary>
public enum AetherNetSecurityEventKind : byte
{
...
/// <see cref="IAetherNetTelemetry"/> and may subsequently publish a
...
public sealed record AetherNetSecurityEvent(
    string                                  NodeId,
    AetherNetSecurityEventKind                 Kind,
    AetherNetThreatLevel                       ThreatLevel,
    string                                  Description,
    IReadOnlyDictionary<string, string>     Metadata,
    DateTimeOffset                          OccurredAt)
{
    /// <summary><c>true</c> when <see cref="ThreatLevel"/> is <see cref="AetherNetThreatLevel.High"/> or <see cref="AetherNetThreatLevel.Critical"/>.</summary>
    public bool IsHighSeverity =>
        ThreatLevel is AetherNetThreatLevel.High or AetherNetThreatLevel.Critical;
}

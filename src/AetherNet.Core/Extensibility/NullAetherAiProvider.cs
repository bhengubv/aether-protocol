...
/// <summary>
/// Default (no-op) <see cref="IAetherNetAiProvider"/> — registered automatically when no
/// CircleAI SDK is present. Acts as the canonical reference implementation of the
/// null-provider contract described on <see cref="IAetherNetAiProvider"/>.
///
/// <para>
...
/// </para>
/// </summary>
public sealed class NullAetherNetAiProvider : IAetherNetAiProvider
{
    /// <summary>

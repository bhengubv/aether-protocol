...
public static class ProtocolConstants
{
    ...
    /// <summary>Default check-in window before a contacts-only SOS auto-widens to a full broadcast (seconds). Per-SOS overridable by the sender.</summary>
    public const int SosDefaultEscalateAfterSeconds = 120;

    /// <summary>Default interval at which a broadcasting SOS re-emits its locator beacon (seconds). Per-SOS overridable by the sender.</summary>
    public const int SosDefaultBeaconIntervalSeconds = 60;

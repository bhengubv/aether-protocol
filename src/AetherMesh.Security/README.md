...
X3DH + Double Ratchet (the Signal Protocol), Ed25519 packet signing, AES-256-GCM encryption, HKDF / HMAC key derivation, signed pre-key rotation, OPK pool management. Wire-compatible across all 8 AetherMesh language implementations.

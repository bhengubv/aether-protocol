...
/// </summary>
public readonly struct AetherMeshTag : IEquatable<AetherMeshTag>
{
    // ── Crockford base-32 ────────────────────────────────────────────────────
    ...
    private AetherMeshTag(string value) => Value = value;
    ...
    public static AetherMeshTag FromPublicKey(byte[] publicKey)
    {
        ...
        return new AetherMeshTag(formatted);
    }
    ...
    public static AetherMeshTag Parse(string tag)
    {
    ...
    /// </summary>
    public static bool TryParse(string? tag, out AetherMeshTag result)
    {
        result = default;
        ...
        result = new AetherMeshTag(formatted);
        return true;
    }
    ...
    public bool Equals(AetherMeshTag other) =>
        string.Equals(Value, other.Value, StringComparison.Ordinal);

    public override bool Equals(object? obj) =>
        obj is AetherMeshTag other && Equals(other);

    public override int GetHashCode() =>
        Value?.GetHashCode(StringComparison.Ordinal) ?? 0;

    public static bool operator ==(AetherMeshTag left, AetherMeshTag right) => left.Equals(right);
    public static bool operator !=(AetherMeshTag left, AetherMeshTag right) => !left.Equals(right);
    ...
    public static implicit operator string(AetherMeshTag tag) => tag.ToString();
}

...
public enum AetherMeshRouteEventKind : byte
{
...
/// <see cref="IAetherMeshAiProvider.SuggestRoutesAsync"/> recommendations.
/// </para>
/// </summary>
...
/// <param name="FailureReason">Human-readable reason for a <see cref="AetherMeshRouteEventKind.Failed"/> event; <c>null</c> otherwise.</param>
/// <param name="OccurredAt">UTC timestamp of the event.</param>
public sealed record AetherMeshRouteEvent(
    string                 SourceNodeId,
    string                 DestinationNodeId,
    IReadOnlyList<string>  Path,
    AetherMeshRouteEventKind   Kind,
    ...
    DateTimeOffset         OccurredAt)
{
    ...
    public bool IsFailed => Kind is AetherMeshRouteEventKind.Failed;
}

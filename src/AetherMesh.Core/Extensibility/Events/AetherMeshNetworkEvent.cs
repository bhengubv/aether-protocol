...
public enum AetherMeshNetworkEventKind : byte
{
...
/// <see cref="AetherMeshNodeEvent"/> and <see cref="AetherMeshRouteEvent"/> feeds
...
public sealed record AetherMeshNetworkEvent(
    AetherMeshNetworkEventKind Kind,
    int                    NodeCount,

...
public enum AetherMeshTransportKind : byte
{
...
public enum AetherMeshTransportEventKind : byte
{
...
/// threat patterns and tune <see cref="IAetherMeshAiProvider.GetTransportBiasesAsync"/>.
/// </summary>
...
public sealed record AetherMeshTransportEvent(
    string                    NodeId,
    AetherMeshTransportEventKind  Kind,
    AetherMeshTransportKind       Transport,
    TimeSpan?                 Latency,

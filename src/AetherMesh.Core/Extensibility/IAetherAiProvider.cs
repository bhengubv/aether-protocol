...
/// Returned by <see cref="IAetherMeshAiProvider.GetNetworkHealthAsync"/>.
///
/// <para>
...
/// temporarily degraded. <see cref="NullAetherMeshAiProvider"/> is the registered
/// default and serves as the canonical reference implementation of this contract.
/// </para>
/// </summary>
public interface IAetherMeshAiProvider
{
    /// <summary>

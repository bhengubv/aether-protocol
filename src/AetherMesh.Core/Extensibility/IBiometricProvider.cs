...
//    • AetherMeshTag identity — face-bound cryptographic identity
...
///   <item>AetherMeshTag — optional face-bound cryptographic identity.</item>
...
public interface IBiometricProvider
{
    ...
    /// </summary>
    /// <param name="a">Reference embedding (e.g. stored in AetherMeshTag identity).</param>

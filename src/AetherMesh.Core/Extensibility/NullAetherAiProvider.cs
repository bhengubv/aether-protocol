...
/// <summary>
/// Default (no-op) <see cref="IAetherMeshAiProvider"/> — registered automatically when no
/// CircleAI SDK is present. Acts as the canonical reference implementation of the
/// null-provider contract described on <see cref="IAetherMeshAiProvider"/>.
///
/// <para>
...
/// </para>
/// </summary>
public sealed class NullAetherMeshAiProvider : IAetherMeshAiProvider
{
    /// <summary>

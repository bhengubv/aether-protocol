...
/// <code>
///   meterProviderBuilder.AddMeter(AetherTelemetry.MeterName);
///   tracerProviderBuilder.AddSource(AetherTelemetry.ActivitySourceName);
/// </code>
...
/// </para>
/// </summary>
public static class AetherTelemetry
{
    /// <summary>
    /// Stable meter name used by every counter and histogram in this
    /// class. Hosts call <c>AddMeter("Aether.Protocol")</c> on their
    /// OpenTelemetry MeterProvider to subscribe.
    /// </summary>
    public const string MeterName = "Aether.Protocol";
    ...
    /// <c>AddSource("Aether.Protocol")</c> on their OpenTelemetry
    /// TracerProvider to subscribe.
    /// </summary>
    public const string ActivitySourceName = "Aether.Protocol";
    ...
    public static readonly Counter<long> SosRebroadcastsSuppressed = Meter.CreateCounter<long>(
        "aether.sos.rebroadcasts_suppressed",
        unit: "{packet}",
    ...
    public static readonly Counter<long> MessagingMessagesSent = Meter.CreateCounter<long>(
        "aether.messaging.messages_sent",
        unit: "{message}",
    ...
    public static readonly Counter<long> MessagingMessagesQueued = Meter.CreateCounter<long>(
        "aether.messaging.messages_queued",
        unit: "{message}",
    ...
    ///
    /// <para>
    /// Duplicated here (rather than referenced) because Aether.Core sits
    /// underneath Aether.Security in the dependency graph. The duplication is

...
/// these events via <see cref="IAetherTelemetry"/>.
/// </para>
/// </summary>
public enum AetherThreatLevel : byte
{
...
/// </summary>
public enum AetherSecurityEventKind : byte
{
...
/// <see cref="IAetherTelemetry"/> and may subsequently publish a
...
{
    /// <summary><c>true</c> when <see cref="ThreatLevel"/> is <see cref="AetherThreatLevel.High"/> or <see cref="AetherThreatLevel.Critical"/>.</summary>

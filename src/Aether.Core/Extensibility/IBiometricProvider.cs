...
//    • AetherTag identity — face-bound cryptographic identity
...
/// </para>
/// <list type="bullet">
///   <item><see cref="IHandshakeService"/> — verify co-presence during key exchange.</item>
...
public interface IBiometricProvider
{
    ...
    /// </summary>
    /// <param name="a">Reference embedding (e.g. stored in AetherTag identity).</param>

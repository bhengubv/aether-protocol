...
export class PerTransportMetrics {
     ...
     *                        `success && rttMs > 0`.
     */
    recordSample(rttMs, success, bytesTransferred) {
        this._sampleCount += 1;
     ...
     */
    compositeScore(maxBandwidthBps, powerCostRelative) {
 ...
 */
export function rankTransports(transports) {
    return transports
...
//# sourceMappingURL=ITransportService.js.map
...
/// <summary>
/// Unit tests for the <see cref="IAetherNetAiProvider"/> interface, the
/// <see cref="NullAetherNetAiProvider"/> no-op implementation, and the AI-augmented
...
/// </summary>
public sealed class AetherNetAiProviderTests
{
    // ══════════════════════════════════════════════════════════════════════════════
...
#pragma warning restore CS0067
    ...
    /// </summary>
    private sealed class FakeAiProvider : IAetherNetAiProvider
    {
    ...
    private sealed class ThrowingAiProvider : IAetherNetAiProvider
    {
    ...
    /// <summary>1. NullAetherNetAiProvider.IsAvailable is always false.</summary>
    [Fact]
    public void NullProvider_IsAvailable_IsFalse()
    {
        var provider = new NullAetherNetAiProvider();
        Assert.False(provider.IsAvailable);
    }

    /// <summary>2. NullAetherNetAiProvider.SuggestRoutesAsync returns an empty list.</summary>
    [Fact]
    ...
    /// <summary>3. NullAetherNetAiProvider.GetTransportBiasesAsync returns an empty dictionary.</summary>
    [Fact]
    ...
    /// <summary>4. NullAetherNetAiProvider.AssessThreatAsync returns AiThreatLevel.None.</summary>
    [Fact]
    ...
    {
        IAetherNetAiProvider provider = new NullAetherNetAiProvider();
    ...
    public async Task SuggestRoutes_NonEmpty_ReturnsHighestConfidenceFirst()
    {
        ...
        IAetherNetAiProvider provider = new FakeAiProvider(routes: routes);
    ...
    public async Task SuggestRoutes_NullProvider_NoSuggestions()
    {
        ...
        IAetherNetAiProvider? provider = null;
    ...
    /// <summary>
    /// 19. Calling AddAetherNetProtocol() wires IAetherNetAiProvider as NullAetherNetAiProvider
    ...
    public void DI_DefaultRegistration_ResolvesNullProvider()
    {
        ...
        var provider = sp.GetService<IAetherNetAiProvider>();
        Assert.NotNull(provider);
        Assert.IsType<NullAetherNetAiProvider>(provider);
        Assert.False(provider!.IsAvailable);
    }
}

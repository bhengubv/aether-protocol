...
/// <see cref="NullAetherAiProvider"/> no-op implementation, and the AI-augmented
...
/// </summary>
public sealed class AetherAiProviderTests
{
    // ══════════════════════════════════════════════════════════════════════════════
...
#pragma warning restore CS0067
    ...
    /// </summary>
    private sealed class FakeAiProvider : IAetherAiProvider
    {
    ...
    private sealed class ThrowingAiProvider : IAetherAiProvider
    {
    ...
    /// <summary>1. NullAetherAiProvider.IsAvailable is always false.</summary>
    [Fact]
    public void NullProvider_IsAvailable_IsFalse()
    {
        var provider = new NullAetherAiProvider();
        Assert.False(provider.IsAvailable);
    }

    /// <summary>2. NullAetherAiProvider.SuggestRoutesAsync returns an empty list.</summary>
    [Fact]
    ...
    /// <summary>3. NullAetherAiProvider.GetTransportBiasesAsync returns an empty dictionary.</summary>
    [Fact]
    ...
    /// <summary>4. NullAetherAiProvider.AssessThreatAsync returns AiThreatLevel.None.</summary>
    [Fact]
    ...
    {
        IAetherAiProvider provider = new NullAetherAiProvider();
    ...
    public async Task SuggestRoutes_NonEmpty_ReturnsHighestConfidenceFirst()
    {
        ...
        IAetherAiProvider provider = new FakeAiProvider(routes: routes);
    ...
    public async Task SuggestRoutes_NullProvider_NoSuggestions()
    {
        ...
        IAetherAiProvider? provider = null;
    ...
    /// <summary>
    /// 19. Calling AddAetherProtocol() wires IAetherAiProvider as NullAetherAiProvider
    ...
    public void DI_DefaultRegistration_ResolvesNullProvider()
    {
        ...
        var provider = sp.GetService<IAetherAiProvider>();
        Assert.NotNull(provider);
        Assert.IsType<NullAetherAiProvider>(provider);
        Assert.False(provider!.IsAvailable);
    }
}

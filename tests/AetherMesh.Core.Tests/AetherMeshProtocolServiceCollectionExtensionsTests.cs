...
/// <summary>
/// Verifies the public surface of <c>services.AddAetherMeshProtocol(...)</c>:
...
/// </summary>
public class AetherMeshProtocolServiceCollectionExtensionsTests
{
    // ─── Empty registration ─────────────────────────────────────────

    [Fact]
    public void AddAetherMeshProtocol_NoChainedCalls_RegistersOnlyOptions()
    {
        var services = new ServiceCollection();

        var builder = services.AddAetherMeshProtocol();
        ...
        var options = sp.GetRequiredService<IOptions<AetherMeshOptions>>().Value;
    ...
    [Fact]
    public void AddAetherMeshProtocol_AddSignalProtocol_ResolvesSignalAndPacketSigning()
    {
        var services = new ServiceCollection();
        services.AddAetherMeshProtocol().AddSignalProtocol();
    ...
    [Fact]
    public void AddAetherMeshProtocol_AddRouting_ResolvesRoutingAgainstHostMeshSender()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IMeshSender>(new FakeMeshSender("uhid:local"));
        services.AddAetherMeshProtocol().AddRouting();
    ...
    [Fact]
    public void AddAetherMeshProtocol_AddDtn_ResolvesDtnService()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IMeshSender>(new FakeMeshSender("uhid:local"));
        services.AddAetherMeshProtocol().AddDtn();
    ...
    [Fact]
    public void AddAetherMeshProtocol_AddSosBroadcast_ResolvesSosService()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IMeshSender>(new FakeMeshSender("uhid:local"));
        services.AddAetherMeshProtocol().AddSosBroadcast();
    ...
    [Fact]
    public void AddAetherMeshProtocol_FullChain_ResolvesMessagingService()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IMeshSender>(new FakeMeshSender("uhid:local"));

        services.AddAetherMeshProtocol(opts => opts.LocalUhid = "uhid:local")
                .AddSignalProtocol()
                .AddRouting()
                .AddDtn()
                .AddMessaging();
    ...
    [Fact]
    public void AddAetherMeshProtocol_TwoProviders_ResolveIndependentInstances()
    {
        ServiceProvider Build(string uhid)
        {
            var services = new ServiceCollection();
            services.AddSingleton<IMeshSender>(new FakeMeshSender(uhid));
            services.AddAetherMeshProtocol(opts => opts.LocalUhid = uhid)
                    .AddSignalProtocol()
                    .AddRouting();
    ...
    // ─── AetherMeshOptions binding from IConfiguration ──────────────────

    [Fact]
    public void AddAetherMeshProtocol_BindsFromConfiguration()
    {
    ...
    [Fact]
    public void AddAetherMeshProtocol_AddMessagingWithoutSignal_ThrowsClearException()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IMeshSender>(new FakeMeshSender("uhid:local"));
        var builder = services.AddAetherMeshProtocol().AddRouting();
    ...
    [Fact]
    public void AddAetherMeshProtocol_AddMessagingWithoutRouting_ThrowsClearException()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IMeshSender>(new FakeMeshSender("uhid:local"));
        var builder = services.AddAetherMeshProtocol().AddSignalProtocol();
    ...
    [Fact]
    public void AddAetherMeshProtocol_AddInProcessTransport_RegistersMeshSender()
    {
        var services = new ServiceCollection();
        InProcessTransportService.ResetNetwork();

        services.AddAetherMeshProtocol(opts => opts.LocalUhid = "uhid:transport-test")
    ...
    [Fact]
    public void AddAetherMeshProtocol_DoubleAddSignalProtocol_RegistersOnce()
    {
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddAetherMeshProtocol_BuilderServicesIsSameCollection()
    {
        var services = new ServiceCollection();
        var builder = services.AddAetherMeshProtocol();
        Assert.Same(services, builder.Services);

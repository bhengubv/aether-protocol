...
#ifndef AETHERNET_CHUNK_BITMAP_H
#define AETHERNET_CHUNK_BITMAP_H
...
/// Free with aethernet_bitset_free() when done.
typedef struct {
...
///                     aethernet_bitset_free() on the result.
...
/// Free a bitset returned by aethernet_bitset_encode().
...
#endif /* AETHERNET_CHUNK_BITMAP_H */

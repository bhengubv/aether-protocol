...
#ifndef AETHERNET_TAG_H
#define AETHERNET_TAG_H
...
#define AETHERNET_TAG_LENGTH 12

/** An AetherNetTag value.  Always NUL-terminated; use value[] directly as a
 *  C string when the tag has been produced by aethernet_tag_from_public_key()
 *  or aethernet_tag_parse(). */
typedef struct {
    char value[AETHERNET_TAG_LENGTH];
} aethernet_tag_t;
...
/**
 * Parse a tag string into an aethernet_tag_t.
 *
...
/**
 * Check whether an aethernet_tag_t contains a non-empty, well-formed tag.
 *

...
// Packet types 53–55 are reserved for the AetherNet Bandwidth Measurement
// Framework. They are wire-compatible across all 8 language implementations.
//   53 — BandwidthProbe : sender emits with four-timestamp payload
//   54 — BandwidthAck   : receiver echoes timestamps back
//   55 — BandwidthGossip: handshake warm-start payload (BtlBw + RTprop)
#define AETHERNET_PACKET_BANDWIDTH_PROBE  53
#define AETHERNET_PACKET_BANDWIDTH_ACK    54
#define AETHERNET_PACKET_BANDWIDTH_GOSSIP 55

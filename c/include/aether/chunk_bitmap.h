...
#ifndef AETHER_CHUNK_BITMAP_H
#define AETHER_CHUNK_BITMAP_H
...
/// Free with aether_bitset_free() when done.
typedef struct {
...
///                     aether_bitset_free() on the result.
...
/// Free a bitset returned by aether_bitset_encode().

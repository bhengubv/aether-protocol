 ...
 */
typedef struct {
    uint8_t  id[AETHER_PACKET_ID_SIZE]; // 16-byte UUID
 ...
 */
typedef struct aether_sos_service aether_sos_service_t;
 ...
 */
typedef void (*aether_sos_received_cb)(const aether_sos_alert_t *alert, void *user_data);

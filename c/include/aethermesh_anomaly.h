...
#ifndef AETHERMESH_ANOMALY_H
#define AETHERMESH_ANOMALY_H
...
typedef struct AetherMeshBehavioralAnomalyDetector AetherMeshBehavioralAnomalyDetector;
...
AetherMeshBehavioralAnomalyDetector *aethermesh_anomaly_create(
    ...
    const AetherMeshAnomalyOptions  *opts   /* NULL = defaults */
);
 ...
 * Direct passthrough to aethermesh_reputation_record_sig_failure.
 */

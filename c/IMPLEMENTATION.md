...
- `aethernet_mesh_packet_t` struct (fixed + variable-length fields)
- `aethernet_packet_type_t` enum (26 packet types)
- `aethernet_capabilities_t` bitfield
...
Verified against `/Users/admin/Code/Dev/aether-protocol/src/AetherNet.Core/Protocol/PacketSerializer.cs`:

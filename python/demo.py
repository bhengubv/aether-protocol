...
from aethernet.models import AetherNetNode
...
def create_node(uhid: str) -> AetherNetNode:
    """
...
async def demo_signal_protocol(alice: AetherNetNode, bob: AetherNetNode) -> None:
...
from aethernet.security.signal_protocol import EncryptedPayload

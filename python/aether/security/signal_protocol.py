...
from aether.security.pre_key_store import PreKeyStore
from aether.security.session_store import SignalSessionStore
...
class SignalProtocolService:
    ...
    :class:`aether.security.session_store.InMemorySignalSessionStore` /
    :class:`aether.security.pre_key_store.InMemoryPreKeyStore` (volatile,
    for tests) or :class:`aether.security.session_store.KeyValueSignalSessionStore`
    / :class:`aether.security.pre_key_store.KeyValuePreKeyStore` over an
    :class:`aether.storage.KeyValueStore` (durable).
    ...
    * ``now_provider`` — zero-arg callable returning a :class:`datetime` in
    ...
    def _hydrate_from_session_store_sync(self) -> None:
        ...
        :class:`aether.security.dtos.StoredSignalSession`. Failures on a

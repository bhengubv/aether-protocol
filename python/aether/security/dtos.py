...
:class:`aether.security.signal_protocol.SignalProtocolService`. They are
written through :class:`aether.security.session_store.SignalSessionStore`
and :class:`aether.security.pre_key_store.PreKeyStore` implementations and
...
class StoredSignalSession:
    ...
    Mirrors the field set of :class:`aether.security.signal_protocol.SignalSession`

...
from aethernet.routing.verifier import RouteReplyVerifier, RejectAllRouteReplyVerifier
...
class RoutingService:
    ...
    def __init__(
        ...
        # routes). A host wires a real signature verifier (Ed25519RouteReplyVerifier)
        # to permit legitimate, signed RREPs.
        self._verifier = verifier or RejectAllRouteReplyVerifier()

...
from aethernet.security.pre_key_store import PreKeyStore
from aethernet.security.session_store import SignalSessionStore
from aethernet.constants import MAX_SKIPPED_KEYS, AES_GCM_NONCE_SIZE, AES_GCM_TAG_SIZE
...
class SignalProtocolService:
    ...
    :class:`aethernet.security.session_store.InMemorySignalSessionStore` /
    :class:`aethernet.security.pre_key_store.InMemoryPreKeyStore` (volatile,
    for tests) or :class:`aethernet.security.session_store.KeyValueSignalSessionStore`
    / :class:`aethernet.security.pre_key_store.KeyValuePreKeyStore` over an
    :class:`aethernet.storage.KeyValueStore` (durable).
    ...
    * ``now_provider`` — zero-arg callable returning a :class:`datetime` in
    ...
    def _hydrate_from_session_store_sync(self) -> None:
        ...
        :class:`aethernet.security.dtos.StoredSignalSession`. Failures on a

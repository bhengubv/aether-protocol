...
:class:`aethernet.security.signal_protocol.SignalProtocolService`. They are
written through :class:`aethernet.security.session_store.SignalSessionStore`
and :class:`aethernet.security.pre_key_store.PreKeyStore` implementations and
...
class StoredSignalSession:
    ...
    Mirrors the field set of :class:`aethernet.security.signal_protocol.SignalSession`
    one-for-one. Stored under ``signal:session:<peer_uhid>`` by
    :class:`aethernet.security.session_store.KeyValueSignalSessionStore`.
    """

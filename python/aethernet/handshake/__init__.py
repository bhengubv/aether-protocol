...
Mirrors the C# `AetherNet.Handshake` namespace. Peers exchange a Hello/HelloAck
...
from aethernet.handshake.models import (
    HelloPayload,
    PeerCapabilities,
    IncompatiblePeerEvent,
)
from aethernet.handshake.service import HandshakeService

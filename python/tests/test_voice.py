...
from aethernet.voice.service import VoiceCallService, VoiceCallState, _pack_voice_frame
from aethernet.voice.group_service import GroupVoiceCallService, _pack_group_frame

...
// Stand up a fresh in-memory relay. Models the real CircleAetherMeshAPI endpoints:
...
else
{
    ...
    // In production, RecordAsync() inserts into aethermesh_reward_events (PostgreSQL)
...
// ─── InProcessApiRelay — simulates CircleAetherMeshAPI relay + pre-key store ──────
...
file sealed class InProcessApiRelay
{
    ...
    // Mirrors aethermesh_reward_events (PostgreSQL) + IncentivesAPI /api/xp/award.

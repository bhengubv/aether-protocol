...
final class SignalFixtureTests: XCTestCase {
    ...
    private func repoRoot() throws -> URL {
        ...
        for _ in 0..<10 {
            if FileManager.default.fileExists(atPath: dir.appendingPathComponent("AetherNetProtocol.slnx").path) {
                return dir
            }
            dir = dir.deletingLastPathComponent()
        }
        throw NSError(domain: "fixture", code: 3,
                      userInfo: [NSLocalizedDescriptionKey: "AetherNetProtocol.slnx not found above \(#filePath)"])
    }

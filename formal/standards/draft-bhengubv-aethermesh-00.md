---
title: "AetherMesh: A Formally Verified Offline-First Mesh Networking Protocol"
abbrev: aethermesh
docname: draft-bhengubv-aethermesh-00
category: exp
ipr: trust200902
area: Routing
...
informative:
  ...
  CPN:
    ...
    date: 2009
  AETHERFORMAL:
    title: "AetherMesh Formal Verification — formal/ Directory"
    target: https://github.com/bhengubv/aether-protocol/tree/main/formal

--- abstract

This document specifies AetherMesh, an offline-first peer-to-peer mesh
networking protocol designed for environments with intermittent or
absent connection to traditional internet infrastructure. AetherMesh
...
AetherMesh provides an alternative network stack designed to function
...
- The addressing scheme: AetherMeshTag (Section 5)
...
- **Node** refers to an AetherMesh-speaking endpoint (typically a mobile
...
- **AetherMeshTag** refers to the human-readable identifier derived
...
The AetherMesh routing layer is derived from AODV {{RFC3561}} with
...
AetherMesh uses the Signal Protocol {{SIGNAL}} (X3DH + Double Ratchet)
...
AetherMesh applies Petri net formal verification {{PETRI}}, {{CPN}}
...
Implementations claiming AetherMesh compliance MUST satisfy the
properties stated in `formal/` for each layer they implement.

# Security Considerations

The security analysis of AetherMesh is built on the formal models in

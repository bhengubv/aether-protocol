...
application {
    mainClass.set("aethernet.DemoKt")
}
...
//     }
//   }
//   dependencies { implementation("dev.aethernet:aethernet-protocol-kotlin:1.0.0") }
//
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            artifactId = "aethernet-protocol-kotlin"
            from(components["java"])
            pom {
                name.set("AetherNet Protocol Kotlin")
                description.set("Kotlin/JVM implementation of the AetherNet mesh networking protocol")

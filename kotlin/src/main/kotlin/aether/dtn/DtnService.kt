...
import aether.extensibility.BackendClient
import aether.extensibility.IncentiveProvider
import aether.extensibility.NoopBackendClient
...
import aether.models.DtnDeliveryReceipt
...
private fun encodeBundle(b: aether.models.DtnBundle): ByteArray {
...
private fun decodeBundle(payload: ByteArray): aether.models.DtnBundle? {
    return try {
        ...
        val maxCopies = JsonReader.readInt(s, "max_copies") ?: aether.AetherConstants.DTN_MAX_COPIES
...
private fun encodeDeliveryReceipt(r: aether.models.DtnDeliveryReceipt): ByteArray {
...
private fun parseDeliveryReceipt(payload: ByteArray): aether.models.DtnDeliveryReceipt? {
    return try {
        val s = String(payload, Charsets.UTF_8)
        val id = UUID.fromString(JsonReader.readString(s, "bundle_id") ?: return null)
        ...
        aether.models.DtnDeliveryReceipt(
            bundleId = id,

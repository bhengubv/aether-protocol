...
data class MeshPacket(
    ...
    var ttl: Int = AetherConstants.DEFAULT_TTL,
    var priority: Byte = 0,
    ...
    var protocolVersion: Byte = AetherConstants.PROTOCOL_VERSION_CURRENT.toByte()
) {
    /**
     * Returns true if this packet has exceeded the maximum allowed age.
     */
    fun isExpired(maxAgeSeconds: Int = AetherConstants.MAX_PACKET_AGE_SECONDS): Boolean {

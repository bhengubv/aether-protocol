...
import aether.voice.JsonReader
import aether.voice.jsonEscape
...
class StreamingService(private val sender: MeshSender) {
    ...
    private fun handleAnnounce(packet: MeshPacket) {
        ...
        val segmentMs = JsonReader.readInt(json, "segment_duration_ms") ?: AetherConstants.DEFAULT_SEGMENT_DURATION_MS.toInt()

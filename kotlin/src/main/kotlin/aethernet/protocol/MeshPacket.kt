...
data class MeshPacket(
    ...
    var ttl: Int = AetherNetConstants.DEFAULT_TTL,
    var priority: Byte = 0,
    ...
    var protocolVersion: Byte = AetherNetConstants.PROTOCOL_VERSION_CURRENT.toByte()
) {
    /**
     * Returns true if this packet has exceeded the maximum allowed age.
     */
    fun isExpired(maxAgeSeconds: Int = AetherNetConstants.MAX_PACKET_AGE_SECONDS): Boolean {

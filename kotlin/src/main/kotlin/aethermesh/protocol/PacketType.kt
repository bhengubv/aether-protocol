...
enum class PacketType(val value: Byte) {
     ...
     * payload is a UTF-8 JSON-encoded `HelloPayload` (see the `aethermesh.handshake`
     ...
     * Payload is UTF-8 JSON-encoded [aethermesh.reputation.ReputationGossipService.ReputationUpdatePayload].

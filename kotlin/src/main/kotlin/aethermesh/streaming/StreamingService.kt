...
import aethermesh.voice.JsonReader
import aethermesh.voice.jsonEscape
...
class StreamingService(private val sender: MeshSender) {
    ...
    private fun handleAnnounce(packet: MeshPacket) {
        ...
        val segmentMs = JsonReader.readInt(json, "segment_duration_ms") ?: AetherMeshConstants.DEFAULT_SEGMENT_DURATION_MS.toInt()

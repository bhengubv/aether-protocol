...
import aethermesh.models.BundlePriority
import aethermesh.models.CustodyRecord
import aethermesh.models.DtnBundle
import aethermesh.models.DtnDeliveryReceipt
...
class DtnService(
    ...
    private suspend fun handleBundle(packet: MeshPacket) {
        ...
        if (store.getActiveCount() >= AetherMeshConstants.DTN_MAX_BUNDLES_PER_NODE) {
...
private fun encodeBundle(b: aethermesh.models.DtnBundle): ByteArray {
...
private fun decodeBundle(payload: ByteArray): aethermesh.models.DtnBundle? {
    return try {
        ...
        val maxCopies = JsonReader.readInt(s, "max_copies") ?: aethermesh.AetherMeshConstants.DTN_MAX_COPIES
...
private fun encodeDeliveryReceipt(r: aethermesh.models.DtnDeliveryReceipt): ByteArray {
...
private fun parseDeliveryReceipt(payload: ByteArray): aethermesh.models.DtnDeliveryReceipt? {
    return try {
        val s = String(payload, Charsets.UTF_8)
        val id = UUID.fromString(JsonReader.readString(s, "bundle_id") ?: return null)
        ...
        aethermesh.models.DtnDeliveryReceipt(
            bundleId = id,

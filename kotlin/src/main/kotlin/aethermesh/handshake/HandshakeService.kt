 ...
 *
 * Mirrors `AetherMesh.Handshake.HandshakeService` (C#) one-for-one. The JSON
...
class HandshakeService(
    ...
    private val ourMaxVersion: Byte = AetherMeshConstants.PROTOCOL_VERSION_CURRENT.toByte(),
